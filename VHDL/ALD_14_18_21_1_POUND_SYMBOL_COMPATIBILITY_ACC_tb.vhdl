...
uut_process: process
   ...
   wait for 30 ns;
   check1(MS_LB_OP_DOT_B_CY,'1',testName,"1A");
   PS_B_CYCLE_1 <= '1';
   PS_1401_POUND_SIGN_OP_CODE <= '0';
   wait for 30 ns;
   check1(MS_LB_OP_DOT_B_CY,'1',testName,"1B");
   PS_1401_POUND_SIGN_OP_CODE <= '1';
   wait for 30 ns;
   check1(MS_LB_OP_DOT_B_CY,'0',testName,"1C");
   ...
   PS_1ST_SCAN <= '1';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_1ST_SCAN_DOT_UNITS,'1',testName,"2A");      
   PS_B_CYCLE_1 <= '1';
   PS_1401_POUND_SIGN_OP_CODE <= '0';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_1ST_SCAN_DOT_UNITS,'1',testName,"2B");      
   PS_1401_POUND_SIGN_OP_CODE <= '1';
   PS_UNITS_LATCH <= '0';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_1ST_SCAN_DOT_UNITS,'1',testName,"2C");      
   PS_UNITS_LATCH <= '1';
   PS_1ST_SCAN <= '0';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_1ST_SCAN_DOT_UNITS,'1',testName,"2D");      
   PS_1ST_SCAN <= '1';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_1ST_SCAN_DOT_UNITS,'0',testName,"2E");      
   PS_UNITS_LATCH <= '0';
   ...
   PS_1ST_SCAN <= '1';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_1ST_SCAN,'1',testName,"3A");
   PS_B_CYCLE_1 <= '1';
   PS_1401_POUND_SIGN_OP_CODE <= '0';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_1ST_SCAN,'1',testName,"3B");
   PS_1401_POUND_SIGN_OP_CODE <= '1';
   PS_1ST_SCAN <= '0';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_1ST_SCAN,'1',testName,"3C");
   PS_1ST_SCAN <= '1';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_1ST_SCAN,'0',testName,"3D");
   PS_1ST_SCAN <= '0';
   ...
   PS_BODY_LATCH <= '1';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_BODY_LATCH,'1',testName,"4A");   
   PS_B_CYCLE_1 <= '1';
   PS_1401_POUND_SIGN_OP_CODE <= '0';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_BODY_LATCH,'1',testName,"4B");   
   PS_1401_POUND_SIGN_OP_CODE <= '1';
   PS_BODY_LATCH <= '0';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_BODY_LATCH,'1',testName,"4C");   
   PS_BODY_LATCH <= '1';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_BODY_LATCH,'0',testName,"4D");   
   PS_BODY_LATCH <= '0';
   ...
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_EXTENSION_LATCH,'1',testName,"5A");   
   PS_B_CYCLE_1 <= '1';
   PS_1401_POUND_SIGN_OP_CODE <= '0';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_EXTENSION_LATCH,'1',testName,"5B");   
   PS_1401_POUND_SIGN_OP_CODE <= '1';
   PS_EXTENSION_LATCH <= '0';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_EXTENSION_LATCH,'1',testName,"5C");   
   PS_EXTENSION_LATCH <= '1';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_EXTENSION_LATCH,'0',testName,"5D");   
   PS_BODY_LATCH <= '0';

   PS_B_CYCLE_1 <= '0';
   PS_1401_POUND_SIGN_OP_CODE <= '0';
   PS_1ST_OR_3RD_SCAN <= '1';
   wait for 30 ns;
   check1(MS_LB_OP_DOT_1ST_OR_3RD_SCAN,'1',testName,"6A");
   PS_1401_POUND_SIGN_OP_CODE <= '1';
   PS_1ST_OR_3RD_SCAN <= '0';
   wait for 30 ns;
   check1(MS_LB_OP_DOT_1ST_OR_3RD_SCAN,'1',testName,"6B");
   PS_1ST_OR_3RD_SCAN <= '1';
   wait for 30 ns;
   check1(MS_LB_OP_DOT_1ST_OR_3RD_SCAN,'0',testName,"6C");
   ...
   PS_UNITS_LATCH <= '1';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_3RD_SCAN_DOT_UNITS,'1',testName,"7A");
   PS_B_CYCLE_1 <= '1';
   PS_1401_POUND_SIGN_OP_CODE <= '0';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_3RD_SCAN_DOT_UNITS,'1',testName,"7B");
   PS_1401_POUND_SIGN_OP_CODE <= '1';
   PS_3RD_SCAN <= '0';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_3RD_SCAN_DOT_UNITS,'1',testName,"7C");
   PS_3RD_SCAN <= '1';
   PS_UNITS_LATCH <= '0';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_3RD_SCAN_DOT_UNITS,'1',testName,"7D");
   PS_UNITS_LATCH <= '1';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_3RD_SCAN_DOT_UNITS,'0',testName,"7E");
   PS_3RD_SCAN <= '0';
   PS_UNITS_LATCH <= '0';
   ...
   PS_1401_POUND_SIGN_OP_CODE <= '1';
   PS_EXTENSION_LATCH <= '1';
   PS_ZONE_ADDER_CARRY <= '1';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_EXT_DOT_ZONE_CARRY,'1',testName,"8A");
   PS_B_CYCLE_1 <= '1';
   PS_1401_POUND_SIGN_OP_CODE <= '0';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_EXT_DOT_ZONE_CARRY,'1',testName,"8B");
   PS_1401_POUND_SIGN_OP_CODE <= '1';
   PS_EXTENSION_LATCH <= '0';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_EXT_DOT_ZONE_CARRY,'1',testName,"8C");
   PS_EXTENSION_LATCH <= '1';
   PS_ZONE_ADDER_CARRY <= '0';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_EXT_DOT_ZONE_CARRY,'1',testName,"8D");
   PS_ZONE_ADDER_CARRY <= '1';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_EXT_DOT_ZONE_CARRY,'0',testName,"8E");
   PS_ZONE_ADDER_CARRY <= '0';

   PS_B_CYCLE_1 <= '0';
   PS_1401_POUND_SIGN_OP_CODE <= '1';
   PS_EXTENSION_LATCH <= '1';
   MS_ZONE_ADDER_CARRY <= '1';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_EXT_DOT_NO_ZONE_CAR,'1',testName,"9A");
   PS_B_CYCLE_1 <= '1';
   PS_1401_POUND_SIGN_OP_CODE <= '0';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_EXT_DOT_NO_ZONE_CAR,'1',testName,"9B");
   PS_1401_POUND_SIGN_OP_CODE <= '1';
   PS_EXTENSION_LATCH <= '0';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_EXT_DOT_NO_ZONE_CAR,'1',testName,"9C");
   PS_EXTENSION_LATCH <= '1';
   MS_ZONE_ADDER_CARRY <= '0';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_EXT_DOT_NO_ZONE_CAR,'1',testName,"9D");
   MS_ZONE_ADDER_CARRY <= '1';
   wait for 30 ns;
   check1(MS_LB_DOT_B_CYCLE_DOT_EXT_DOT_NO_ZONE_CAR,'0',testName,"9E");
   ...
   wait for 30 ns;
   check1(MS_LB_OP_DOT_LIROC,'1',testName,"10A");
   PS_1401_POUND_SIGN_OP_CODE <= '1';
   PS_LAST_INSN_RO_CYCLE_2 <= '0';
   wait for 30 ns;
   check1(MS_LB_OP_DOT_LIROC,'1',testName,"10B");
   PS_LAST_INSN_RO_CYCLE_2 <= '1';
   wait for 30 ns;
   check1(MS_LB_OP_DOT_LIROC,'0',testName,"10C");
