-- VHDL for IBM SMS ALD page 14.13.03.1
-- Title: D ADDRESS REGISTER HUNDREDS POS
-- IBM Machine Name 1411
-- Generated by GenerateHDL at 8/18/2020 3:16:49 PM
...
entity ALD_14_13_03_1_D_ADDRESS_REGISTER_HUNDREDS_POS is
	    Port (
		...
		MS_D_AR_GT_OUT_HP0B:	 out STD_LOGIC;
		MS_D_AR_GT_OUT_HP1B:	 out STD_LOGIC;
		MS_D_AR_GT_OUT_HP2B:	 out STD_LOGIC;
		MS_D_AR_GT_OUT_HP4B:	 out STD_LOGIC;
		MS_D_AR_GT_OUT_HP8B:	 out STD_LOGIC);
end ALD_14_13_03_1_D_ADDRESS_REGISTER_HUNDREDS_POS;

architecture behavioral of ALD_14_13_03_1_D_ADDRESS_REGISTER_HUNDREDS_POS is 
...
begin
	...
	OUT_5A_NoPin <= NOT(PS_ADDR_CH_0_B_1 AND PS_SET_AR_H_POS AND PS_SET_D_AR );
	OUT_3A_NoPin_Latch <= NOT(MS_RESET_D_AR AND OUT_2A_NoPin );
	OUT_2A_NoPin_Latch <= NOT(OUT_5A_NoPin AND OUT_3A_NoPin );
	OUT_1A_4 <= NOT(OUT_2A_NoPin AND PS_RO_D_AR );
	OUT_5C_NoPin <= NOT(PS_ADDR_CH_1_B_1 AND PS_SET_AR_H_POS AND PS_SET_D_AR );
	OUT_3C_NoPin_Latch <= NOT(MS_RESET_D_AR AND OUT_2C_NoPin );
	OUT_2C_NoPin_Latch <= NOT(OUT_5C_NoPin AND OUT_3C_NoPin );
	OUT_1C_9 <= NOT(OUT_2C_NoPin AND PS_RO_D_AR );
	OUT_5E_NoPin <= NOT(PS_ADDR_CH_2_B_1 AND PS_SET_AR_H_POS AND PS_SET_D_AR );
	OUT_3E_NoPin_Latch <= NOT(MS_RESET_D_AR AND OUT_2E_NoPin );
	OUT_2E_NoPin_Latch <= NOT(OUT_5E_NoPin AND OUT_3E_NoPin );
	OUT_1E_4 <= NOT(OUT_2E_NoPin AND PS_RO_D_AR );
	OUT_5G_NoPin <= NOT(PS_ADDR_CH_4_B_1 AND PS_SET_AR_H_POS AND PS_SET_D_AR );
	OUT_3G_NoPin_Latch <= NOT(MS_RESET_D_AR AND OUT_2G_NoPin );
	OUT_2G_NoPin_Latch <= NOT(OUT_5G_NoPin AND OUT_3G_NoPin );
	OUT_1G_9 <= NOT(OUT_2G_NoPin AND PS_RO_D_AR );
	OUT_5I_NoPin <= NOT(PS_ADDR_CH_8_B_1 AND PS_SET_AR_H_POS AND PS_SET_D_AR );
	OUT_3I_NoPin_Latch <= NOT(MS_RESET_D_AR AND OUT_2I_NoPin );
	OUT_2I_NoPin_Latch <= NOT(OUT_5I_NoPin AND OUT_3I_NoPin );
	OUT_1I_4 <= NOT(OUT_2I_NoPin AND PS_RO_D_AR );

	MS_D_AR_GT_OUT_HP0B <= OUT_1A_4;
	MS_D_AR_GT_OUT_HP1B <= OUT_1C_9;
	MS_D_AR_GT_OUT_HP2B <= OUT_1E_4;
	MS_D_AR_GT_OUT_HP4B <= OUT_1G_9;
	MS_D_AR_GT_OUT_HP8B <= OUT_1I_4;
