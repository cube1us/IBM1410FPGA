...
-- Generated by GenerateHDL at 11/7/2020 2:54:56 PM
...
begin
	...
	OUT_5A_A <= NOT SWITCH_ROT_TENS_SYNC_DK2(1);
	OUT_5A_B <= NOT SWITCH_ROT_TENS_SYNC_DK2(2);
	OUT_5A_K <= NOT SWITCH_ROT_TENS_SYNC_DK2(3);
	OUT_5A_D <= NOT SWITCH_ROT_TENS_SYNC_DK2(4);
	OUT_5A_E <= NOT SWITCH_ROT_TENS_SYNC_DK2(5);
	OUT_5A_F <= NOT SWITCH_ROT_TENS_SYNC_DK2(6);
	OUT_5A_G <= NOT SWITCH_ROT_TENS_SYNC_DK2(7);
	OUT_5A_H <= NOT SWITCH_ROT_TENS_SYNC_DK2(8);
	OUT_5A_J <= NOT SWITCH_ROT_TENS_SYNC_DK2(9);
	OUT_5A_L <= NOT SWITCH_ROT_TENS_SYNC_DK2(10);
	...
	OUT_5C_A <= NOT SWITCH_ROT_TENS_SYNC_DK1(1);
	OUT_5C_B <= NOT SWITCH_ROT_TENS_SYNC_DK1(2);
	OUT_5C_K <= NOT SWITCH_ROT_TENS_SYNC_DK1(3);
	OUT_5C_D <= NOT SWITCH_ROT_TENS_SYNC_DK1(4);
	OUT_5C_E <= NOT SWITCH_ROT_TENS_SYNC_DK1(5);
	OUT_5C_F <= NOT SWITCH_ROT_TENS_SYNC_DK1(6);
	OUT_5C_G <= NOT SWITCH_ROT_TENS_SYNC_DK1(7);
	OUT_5C_H <= NOT SWITCH_ROT_TENS_SYNC_DK1(8);
	OUT_5C_J <= NOT SWITCH_ROT_TENS_SYNC_DK1(9);
	OUT_5C_L <= NOT SWITCH_ROT_TENS_SYNC_DK1(10);
	...
	OUT_5F_A <= NOT SWITCH_ROT_UNITS_SYNC_DK2(1);
	OUT_5F_B <= NOT SWITCH_ROT_UNITS_SYNC_DK2(2);
	OUT_5F_K <= NOT SWITCH_ROT_UNITS_SYNC_DK2(3);
	OUT_5F_D <= NOT SWITCH_ROT_UNITS_SYNC_DK2(4);
	OUT_5F_E <= NOT SWITCH_ROT_UNITS_SYNC_DK2(5);
	OUT_5F_F <= NOT SWITCH_ROT_UNITS_SYNC_DK2(6);
	OUT_5F_G <= NOT SWITCH_ROT_UNITS_SYNC_DK2(7);
	OUT_5F_H <= NOT SWITCH_ROT_UNITS_SYNC_DK2(8);
	OUT_5F_J <= NOT SWITCH_ROT_UNITS_SYNC_DK2(9);
	OUT_5F_L <= NOT SWITCH_ROT_UNITS_SYNC_DK2(10);
	OUT_3F_D <= NOT(MY_MEM_AR_NOT_UP0B AND OUT_DOT_4F );
	OUT_3G_NoPin <= NOT(OUT_DOT_5F AND MY_MEM_AR_NOT_UP1B );
	OUT_5H_A <= NOT SWITCH_ROT_UNITS_SYNC_DK1(1);
	OUT_5H_B <= NOT SWITCH_ROT_UNITS_SYNC_DK1(2);
	OUT_5H_K <= NOT SWITCH_ROT_UNITS_SYNC_DK1(3);
	OUT_5H_D <= NOT SWITCH_ROT_UNITS_SYNC_DK1(4);
	OUT_5H_E <= NOT SWITCH_ROT_UNITS_SYNC_DK1(5);
	OUT_5H_F <= NOT SWITCH_ROT_UNITS_SYNC_DK1(6);
	OUT_5H_G <= NOT SWITCH_ROT_UNITS_SYNC_DK1(7);
	OUT_5H_H <= NOT SWITCH_ROT_UNITS_SYNC_DK1(8);
	OUT_5H_J <= NOT SWITCH_ROT_UNITS_SYNC_DK1(9);
	OUT_5H_L <= NOT SWITCH_ROT_UNITS_SYNC_DK1(10);
