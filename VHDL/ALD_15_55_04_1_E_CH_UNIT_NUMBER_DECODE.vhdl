-- VHDL for IBM SMS ALD page 15.55.04.1
-- Title: E CH UNIT NUMBER DECODE
-- IBM Machine Name 1411
-- Generated by GenerateHDL at 9/16/2020 8:57:57 PM
...
entity ALD_15_55_04_1_E_CH_UNIT_NUMBER_DECODE is
	    Port (
...
end ALD_15_55_04_1_E_CH_UNIT_NUMBER_DECODE;

architecture behavioral of ALD_15_55_04_1_E_CH_UNIT_NUMBER_DECODE is 
...
begin
	...
	OUT_4A_G <= NOT(PS_E_CH_UNIT_NU_REG_C_BIT AND PS_E_CH_UNIT_NU_REG_8_BIT AND PS_E_CH_UNIT_NU_REG_2_BIT );
	OUT_3A_C <= NOT(OUT_DOT_4A AND OUT_3B_K );
	OUT_2A_F <= NOT OUT_3A_C;
	OUT_1A_A <= OUT_2A_F;
	OUT_4B_G <= NOT(PS_E_CH_UNIT_NU_REG_NOT_1_BIT AND PS_E_CH_UNIT_NU_REG_NOT_4_BIT );
	OUT_3B_K <= NOT(MS_LOZ_SYMBOL_OP_MODIFIER AND PS_1401_PRINT_TRIGGER );
	OUT_2B_L <= OUT_3A_C;
	OUT_1B_A <= OUT_2A_F;
	OUT_4C_P <= NOT(PS_1401_PRINT_TRIGGER AND PS_LOZ_SYMBOL_OP_MODIFIER );
	OUT_1C_A <= OUT_2A_F;
	OUT_4D_G <= NOT(PS_E_CH_UNIT_NU_REG_1_BIT AND PS_E_CH_UNIT_NU_REG_NOT_2_BIT );
	OUT_3D_G <= NOT(OUT_4C_P AND OUT_DOT_4D );
	OUT_2D_R <= NOT OUT_3D_G;
	OUT_1D_E <= OUT_2D_R;
	OUT_4E_G <= NOT(PS_E_CH_UNIT_NU_REG_NOT_4_BIT AND PS_E_CH_UNIT_NU_REG_NOT_8_BIT AND PS_E_CH_UNIT_NU_REG_NOT_C_BIT );
	OUT_1E_E <= OUT_2D_R;
	OUT_1F_E <= OUT_2D_R;
	OUT_4G_G <= NOT(PS_E_CH_UNIT_NU_REG_NOT_4_BIT AND PS_E_CH_UNIT_NU_REG_NOT_1_BIT );
	OUT_3G_C <= NOT(OUT_DOT_4G );
	OUT_2G_B <= NOT OUT_3G_C;
	OUT_1G_G <= OUT_2G_B;
	OUT_4H_G <= NOT(PS_E_CH_UNIT_NU_REG_2_BIT AND PS_E_CH_UNIT_NU_REG_NOT_C_BIT AND PS_E_CH_UNIT_NU_REG_NOT_8_BIT );
	OUT_1H_G <= OUT_2G_B;
	OUT_1I_G <= OUT_2G_B;
	...
	MS_E_CH_UNIT_NUMBER_0 <= OUT_2A_F;
	MC_UNIT_NU_0_TO_TAU_STAR_E_CH <= OUT_1A_A;
	PS_E_CH_UNIT_NUMBER_0 <= OUT_2B_L;
	MC_SELECT_NO_0_TO_BUFFER <= OUT_1B_A;
	MC_SEEK_STAR_E_CH_1405 <= OUT_1C_A;
	PS_E_CH_UNIT_NUMBER_1 <= OUT_3D_G;
	MS_E_CH_UNIT_NUMBER_1 <= OUT_2D_R;
	MC_UNIT_NU_1_TO_TAU_STAR_E_CH <= OUT_1D_E;
	MC_SELECT_NO_1_TO_BUFFER <= OUT_1E_E;
	MC_SINGLE_REC_STAR_E_CH_TO_1405 <= OUT_1F_E;
	MC_UNIT_NU_2_TO_TAU_STAR_E_CH <= OUT_1G_G;
	MC_SELECT_NO_2_TO_BUFFER <= OUT_1H_G;
	MC_FULL_TRACK_WITHOUT_IA_STAR_1405_E_CH <= OUT_1I_G;
