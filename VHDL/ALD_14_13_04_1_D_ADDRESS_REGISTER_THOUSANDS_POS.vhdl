-- VHDL for IBM SMS ALD page 14.13.04.1
-- Title: D ADDRESS REGISTER THOUSANDS POS
-- IBM Machine Name 1411
-- Generated by GenerateHDL at 8/18/2020 3:25:53 PM
...
entity ALD_14_13_04_1_D_ADDRESS_REGISTER_THOUSANDS_POS is
	    Port (
		...
		MS_D_AR_GT_OUT_THP0B:	 out STD_LOGIC;
		MS_D_AR_GT_OUT_THP1B:	 out STD_LOGIC;
		MS_D_AR_GT_OUT_THP2B:	 out STD_LOGIC;
		MS_D_AR_GT_OUT_THP4B:	 out STD_LOGIC;
		MS_D_AR_GT_OUT_THP8B:	 out STD_LOGIC);
end ALD_14_13_04_1_D_ADDRESS_REGISTER_THOUSANDS_POS;

architecture behavioral of ALD_14_13_04_1_D_ADDRESS_REGISTER_THOUSANDS_POS is 
...
begin
	...
	OUT_5A_NoPin <= NOT(PS_ADDR_CH_0_B_1 AND PS_SET_AR_TH_POS AND PS_SET_D_AR );
	...
	OUT_5C_NoPin <= NOT(PS_ADDR_CH_1_B_1 AND PS_SET_AR_TH_POS AND PS_SET_D_AR );
	...
	OUT_5E_NoPin <= NOT(PS_ADDR_CH_2_B_1 AND PS_SET_AR_TH_POS AND PS_SET_D_AR );
	...
	OUT_5G_NoPin <= NOT(PS_ADDR_CH_4_B_1 AND PS_SET_AR_TH_POS AND PS_SET_D_AR );
	...
	OUT_5I_NoPin <= NOT(PS_ADDR_CH_8_B_1 AND PS_SET_AR_TH_POS AND PS_SET_D_AR );
	...
	MS_D_AR_GT_OUT_THP0B <= OUT_1A_9;
	MS_D_AR_GT_OUT_THP1B <= OUT_1C_4;
	MS_D_AR_GT_OUT_THP2B <= OUT_1E_9;
	MS_D_AR_GT_OUT_THP4B <= OUT_1G_4;
	MS_D_AR_GT_OUT_THP8B <= OUT_1I_9;
