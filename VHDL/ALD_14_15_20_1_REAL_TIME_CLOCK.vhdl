...
-- Generated by GenerateHDL at 8/19/2020 3:07:52 PM
...
begin
	...
	OUT_3B_A <= SWITCH_ROT_M_RTC_023(1) AND OUT_4B_F;
	OUT_3B_K <= SWITCH_ROT_M_RTC_023(3) AND OUT_4B_F;
	OUT_3B_D <= SWITCH_ROT_M_RTC_023(4) AND OUT_4B_F;
	OUT_2C_F <= SWITCH_ROT_M_RTC_578(6) AND OUT_4B_F;
	OUT_2C_H <= SWITCH_ROT_M_RTC_578(8) AND OUT_4B_F;
	OUT_2C_J <= SWITCH_ROT_M_RTC_578(9) AND OUT_4B_F;
	OUT_4D_R <= NOT MS_REAL_TIME_CLOCK_GATE_B;
	OUT_3D_B <= SWITCH_ROT_MRTC_01234(2) AND OUT_4D_R;
	OUT_3D_A <= SWITCH_ROT_MRTC_01234(1) AND OUT_4D_R;
	OUT_3D_K <= SWITCH_ROT_MRTC_01234(3) AND OUT_4D_R;
	OUT_3D_D <= SWITCH_ROT_MRTC_01234(4) AND OUT_4D_R;
	OUT_3D_E <= SWITCH_ROT_MRTC_01234(5) AND OUT_4D_R;
	OUT_2E_F <= SWITCH_ROT_MRTC_56789(6) AND OUT_4D_R;
	OUT_2E_G <= SWITCH_ROT_MRTC_56789(7) AND OUT_4D_R;
	OUT_2E_H <= SWITCH_ROT_MRTC_56789(8) AND OUT_4D_R;
	OUT_2E_J <= SWITCH_ROT_MRTC_56789(9) AND OUT_4D_R;
	OUT_2E_L <= SWITCH_ROT_MRTC_56789(10) AND OUT_4D_R;
	OUT_4F_B <= NOT MS_REAL_TIME_CLOCK_GATE_C;
	OUT_3F_A <= SWITCH_ROT_HRTC_01234(1) AND OUT_4F_B;
	OUT_3F_B <= SWITCH_ROT_HRTC_01234(2) AND OUT_4F_B;
	OUT_3F_K <= SWITCH_ROT_HRTC_01234(3) AND OUT_4F_B;
	OUT_3F_D <= SWITCH_ROT_HRTC_01234(4) AND OUT_4F_B;
	OUT_3F_E <= SWITCH_ROT_HRTC_01234(5) AND OUT_4F_B;
	OUT_2G_F <= SWITCH_ROT_HRTC_56789(6) AND OUT_4F_B;
	OUT_2G_G <= SWITCH_ROT_HRTC_56789(7) AND OUT_4F_B;
	OUT_2G_H <= SWITCH_ROT_HRTC_56789(8) AND OUT_4F_B;
	OUT_2G_J <= SWITCH_ROT_HRTC_56789(9) AND OUT_4F_B;
	OUT_2G_L <= SWITCH_ROT_HRTC_56789(10) AND OUT_4F_B;
	OUT_4H_F <= NOT MS_REAL_TIME_CLOCK_GATE_D;
	OUT_3H_A <= SWITCH_ROT_HRTC_012(1) AND OUT_4H_F;
	OUT_3H_B <= SWITCH_ROT_HRTC_012(2) AND OUT_4H_F;
	OUT_3H_D <= SWITCH_ROT_HRTC_012(4) AND OUT_4H_F;
	OUT_DOT_3A <= OUT_3B_A OR OUT_3D_A OR OUT_3F_A OR OUT_3H_A;
	OUT_DOT_3B <= OUT_3B_K OR OUT_3D_K OR OUT_3F_K OR OUT_3H_D;
