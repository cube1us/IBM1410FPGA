-- Test Bench VHDL for IBM SMS ALD page 19.10.04.1
...
entity ALD_19_10_04_1_INTERRUPT_CONTROLS_tb is
end ALD_19_10_04_1_INTERRUPT_CONTROLS_tb;

architecture behavioral of ALD_19_10_04_1_INTERRUPT_CONTROLS_tb is

	-- Component Declaration for the Unit Under Test (UUT)

	component ALD_19_10_04_1_INTERRUPT_CONTROLS
	    Port (
...
-- END USER TEST BENCH DECLARATIONS
	...
	UUT: ALD_19_10_04_1_INTERRUPT_CONTROLS port map(
		FPGA_CLK => FPGA_CLK,
...
uut_process: process
   ...
   for tt in 0 to 2**4 loop
      ...
      check1(MS_INTERRUPT_DOT_B_CYCLE,not(not c and b and a),testName,"Interrupt . B Cycle");
      check1(PS_INTERRUPT_TEST_OP_CODE,d,testName,"Interrupt Test Op Code");
      check1(PS_INTERRUPT_TEST_OP_CODE_1,d,testName,"Interrupt Test Op Code 1");
