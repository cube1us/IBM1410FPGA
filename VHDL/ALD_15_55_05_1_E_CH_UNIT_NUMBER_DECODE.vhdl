-- VHDL for IBM SMS ALD page 15.55.05.1
-- Title: E CH UNIT NUMBER DECODE
-- IBM Machine Name 1411
-- Generated by GenerateHDL at 9/16/2020 8:58:03 PM
...
entity ALD_15_55_05_1_E_CH_UNIT_NUMBER_DECODE is
	    Port (
...
end ALD_15_55_05_1_E_CH_UNIT_NUMBER_DECODE;

architecture behavioral of ALD_15_55_05_1_E_CH_UNIT_NUMBER_DECODE is 
...
begin
	...
	OUT_4A_G <= NOT(PS_E_CH_UNIT_NU_REG_2_BIT AND PS_E_CH_UNIT_NU_REG_NOT_4_BIT AND PS_E_CH_UNIT_NU_REG_C_BIT );
	OUT_3A_C <= NOT(OUT_DOT_4A );
	OUT_2A_D <= NOT OUT_3A_C;
	OUT_1A_H <= OUT_2A_D;
	OUT_4B_G <= NOT(PS_E_CH_UNIT_NU_REG_1_BIT AND PS_E_CH_UNIT_NU_REG_NOT_8_BIT );
	OUT_1B_H <= OUT_2A_D;
	OUT_1C_H <= OUT_2A_D;
	OUT_4D_G <= NOT(PS_E_CH_UNIT_NU_REG_NOT_C_BIT AND PS_E_CH_UNIT_NU_REG_NOT_1_BIT );
	OUT_3D_C <= NOT(OUT_DOT_4D );
	OUT_2D_C <= NOT OUT_3D_C;
	OUT_1D_A <= OUT_2D_C;
	OUT_4E_G <= NOT(PS_E_CH_UNIT_NU_REG_NOT_8_BIT AND PS_E_CH_UNIT_NU_REG_NOT_2_BIT AND PS_E_CH_UNIT_NU_REG_4_BIT );
	OUT_1F_A <= OUT_2D_C;
	OUT_4G_G <= NOT(PS_E_CH_UNIT_NU_REG_NOT_8_BIT AND PS_E_CH_UNIT_NU_REG_C_BIT );
	OUT_1G_E <= OUT_DOT_4G;
	OUT_4H_G <= NOT(PS_E_CH_UNIT_NU_REG_1_BIT AND PS_E_CH_UNIT_NU_REG_4_BIT AND PS_E_CH_UNIT_NU_REG_NOT_2_BIT );
	OUT_DOT_4A <= OUT_4A_G OR OUT_4B_G;
	OUT_DOT_4D <= OUT_4D_G OR OUT_4E_G;
	OUT_DOT_4G <= OUT_4G_G OR OUT_4H_G;

	PS_E_CH_UNIT_NUMBER_3 <= OUT_3A_C;
	MS_E_CH_UNIT_NUMBER_3 <= OUT_2A_D;
	MC_UNIT_NU_3_TO_TAU_STAR_E_CH <= OUT_1A_H;
	MC_SELECT_NO_3_TO_BUFFER <= OUT_1B_H;
	MC_WRITE_CHECK_STAR_E_CH_TO_1405 <= OUT_1C_H;
	MS_E_CH_UNIT_NUMBER_4 <= OUT_2D_C;
	MC_UNIT_NU_4_TO_TAU_STAR_E_CH <= OUT_1D_A;
	MC_WRITE_ADDR_STAR_E_CH_TO_1405 <= OUT_1F_A;
	MC_UNIT_NU_5_TO_TAU_STAR_E_CH <= OUT_1G_E;
