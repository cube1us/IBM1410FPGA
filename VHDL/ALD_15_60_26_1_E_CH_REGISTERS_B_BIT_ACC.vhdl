-- VHDL for IBM SMS ALD page 15.60.26.1
-- Title: E CH REGISTERS B BIT-ACC
-- IBM Machine Name 1411
-- Generated by GenerateHDL at 9/18/2020 5:45:11 PM
...
entity ALD_15_60_26_1_E_CH_REGISTERS_B_BIT_ACC is
	    Port (
		...
		MS_E2_REG_B_BIT:	 out STD_LOGIC;
		PS_E2_REG_B_BIT:	 out STD_LOGIC);
end ALD_15_60_26_1_E_CH_REGISTERS_B_BIT_ACC;

architecture behavioral of ALD_15_60_26_1_E_CH_REGISTERS_B_BIT_ACC is 
...
begin
	...
	OUT_4B_NoPin <= NOT(MS_E1_INPUT_B_BIT AND PS_SET_E1_REG );
	OUT_3B_C_Latch <= NOT(OUT_4B_NoPin AND OUT_2B_D );
	OUT_2B_D_Latch <= NOT(OUT_3B_C AND OUT_4C_C );
	OUT_4C_C <= NOT(PS_SET_E1_REG AND PS_E1_INPUT_B_BIT );
	OUT_4F_D <= NOT(OUT_3B_C AND PS_SET_E2_REG AND PS_COPY_E1_BCD_TO_E2_REG );
	OUT_3F_F_Latch <= NOT(OUT_4F_D AND MS_SET_E2_WORD_SEPARATOR AND OUT_2F_NoPin );
	...
	MS_E2_REG_B_BIT <= OUT_1F_E;
	PS_E2_REG_B_BIT <= OUT_1G_D;
