-- VHDL for IBM SMS ALD page 14.14.11.1
-- Title: E ADDRESS REGISTER TENS POS
-- IBM Machine Name 1411
-- Generated by GenerateHDL at 8/18/2020 4:56:59 PM
...
entity ALD_14_14_11_1_E_ADDRESS_REGISTER_TENS_POS is
	    Port (
		...
		MS_E_AR_GT_OUT_TP0B:	 out STD_LOGIC;
		MS_E_AR_GT_OUT_TP1B:	 out STD_LOGIC;
		MS_E_AR_GT_OUT_TP2B:	 out STD_LOGIC;
		MS_E_AR_GT_OUT_TP4B:	 out STD_LOGIC;
		MS_E_AR_GT_OUT_TP8B:	 out STD_LOGIC);
end ALD_14_14_11_1_E_ADDRESS_REGISTER_TENS_POS;

architecture behavioral of ALD_14_14_11_1_E_ADDRESS_REGISTER_TENS_POS is 
...
begin
	...
	OUT_5A_NoPin <= NOT(PS_ADDR_CH_0_B_1 AND PS_SET_AR_T_POS AND PS_SET_E_AR );
	...
	OUT_5C_NoPin <= NOT(PS_SET_AR_T_POS AND PS_ADDR_CH_1_B_1 AND PS_SET_E_AR );
	...
	OUT_5E_NoPin <= NOT(PS_ADDR_CH_2_B_1 AND PS_SET_AR_T_POS AND PS_SET_E_AR );
	...
	OUT_5G_NoPin <= NOT(PS_ADDR_CH_4_B_1 AND PS_SET_AR_T_POS AND PS_SET_E_AR );
	...
	OUT_5I_NoPin <= NOT(PS_ADDR_CH_8_B_1 AND PS_SET_AR_T_POS AND PS_SET_E_AR );
	OUT_3I_NoPin_Latch <= NOT(MS_RESET_E_AR AND OUT_2I_NoPin );
	OUT_2I_NoPin_Latch <= NOT(OUT_5I_NoPin AND OUT_3I_NoPin );
	OUT_1I_9 <= NOT(OUT_2I_NoPin AND PS_RO_E_AR );

	MS_E_AR_GT_OUT_TP0B <= OUT_1A_D;
	MS_E_AR_GT_OUT_TP1B <= OUT_1C_A;
	MS_E_AR_GT_OUT_TP2B <= OUT_1E_9;
	MS_E_AR_GT_OUT_TP4B <= OUT_1G_4;
	MS_E_AR_GT_OUT_TP8B <= OUT_1I_9;
