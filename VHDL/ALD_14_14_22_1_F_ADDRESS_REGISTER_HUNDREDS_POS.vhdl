-- VHDL for IBM SMS ALD page 14.14.22.1
-- Title: F ADDRESS REGISTER HUNDREDS POS
-- IBM Machine Name 1411
-- Generated by GenerateHDL at 8/18/2020 5:12:30 PM
...
entity ALD_14_14_22_1_F_ADDRESS_REGISTER_HUNDREDS_POS is
	    Port (
		...
		MS_F_AR_GT_OUT_HP0B:	 out STD_LOGIC;
		MS_F_AR_GT_OUT_HP1B:	 out STD_LOGIC;
		MS_F_AR_GT_OUT_HP2B:	 out STD_LOGIC;
		MS_F_AR_GT_OUT_HP4B:	 out STD_LOGIC;
		MS_F_AR_GT_OUT_HP8B:	 out STD_LOGIC);
end ALD_14_14_22_1_F_ADDRESS_REGISTER_HUNDREDS_POS;

architecture behavioral of ALD_14_14_22_1_F_ADDRESS_REGISTER_HUNDREDS_POS is 
...
begin
	...
	OUT_5A_NoPin <= NOT(PS_ADDR_CH_0_B_1 AND PS_SET_AR_H_POS AND PS_SET_F_AR );
	OUT_3A_NoPin_Latch <= NOT(MS_RESET_F_AR AND OUT_2A_NoPin );
	OUT_2A_NoPin_Latch <= NOT(OUT_5A_NoPin AND OUT_3A_NoPin );
	OUT_1A_D <= NOT(OUT_2A_NoPin AND PS_RO_F_AR );
	OUT_5C_NoPin <= NOT(PS_SET_AR_H_POS AND PS_ADDR_CH_1_B_1 AND PS_SET_F_AR );
	OUT_3C_NoPin_Latch <= NOT(MS_RESET_F_AR AND OUT_2C_NoPin );
	OUT_2C_NoPin_Latch <= NOT(OUT_5C_NoPin AND OUT_3C_NoPin );
	OUT_1C_A <= NOT(OUT_2C_NoPin AND PS_RO_F_AR );
	OUT_5E_NoPin <= NOT(PS_ADDR_CH_2_B_1 AND PS_SET_AR_H_POS AND PS_SET_F_AR );
	...
	OUT_5G_NoPin <= NOT(PS_SET_AR_H_POS AND PS_ADDR_CH_4_B_1 AND PS_SET_F_AR );
	...
	OUT_5I_NoPin <= NOT(PS_ADDR_CH_8_B_1 AND PS_SET_AR_H_POS AND PS_SET_F_AR );
	OUT_3I_NoPin_Latch <= NOT(MS_RESET_F_AR AND OUT_2I_NoPin );
	OUT_2I_NoPin_Latch <= NOT(OUT_5I_NoPin AND OUT_3I_NoPin );
	OUT_1I_D <= NOT(OUT_2I_NoPin AND PS_RO_F_AR );

	MS_F_AR_GT_OUT_HP0B <= OUT_1A_D;
	MS_F_AR_GT_OUT_HP1B <= OUT_1C_A;
	MS_F_AR_GT_OUT_HP2B <= OUT_1E_D;
	MS_F_AR_GT_OUT_HP4B <= OUT_1G_A;
	MS_F_AR_GT_OUT_HP8B <= OUT_1I_D;
