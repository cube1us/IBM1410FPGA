-- VHDL for IBM SMS ALD page 14.12.03.1
-- Title: C ADDRESS REGISTER HUNDREDS POS
-- IBM Machine Name 1411
-- Generated by GenerateHDL at 8/18/2020 2:09:50 PM
...
entity ALD_14_12_03_1_C_ADDRESS_REGISTER_HUNDREDS_POS is
	    Port (
		...
		MS_C_AR_GT_OUT_HP0B:	 out STD_LOGIC;
		MS_C_AR_GT_OUT_HP1B:	 out STD_LOGIC;
		MS_C_AR_GT_OUT_HP2B:	 out STD_LOGIC;
		MS_C_AR_GT_OUT_HP4B:	 out STD_LOGIC;
		MS_C_AR_GT_OUT_HP8B:	 out STD_LOGIC);
end ALD_14_12_03_1_C_ADDRESS_REGISTER_HUNDREDS_POS;

architecture behavioral of ALD_14_12_03_1_C_ADDRESS_REGISTER_HUNDREDS_POS is 
...
begin
	...
	OUT_5A_NoPin <= NOT(PS_ADDR_CH_0_B_1 AND PS_SET_AR_H_POS AND PS_SET_C_AR );
	...
	OUT_5C_NoPin <= NOT(PS_SET_AR_H_POS AND PS_ADDR_CH_1_B_1 AND PS_SET_C_AR );
	...
	OUT_5E_NoPin <= NOT(PS_ADDR_CH_2_B_1 AND PS_SET_AR_H_POS AND PS_SET_C_AR );
	...
	OUT_5G_NoPin <= NOT(PS_SET_AR_H_POS AND PS_ADDR_CH_4_B_1 AND PS_SET_C_AR );
	...
	OUT_5I_NoPin <= NOT(PS_ADDR_CH_8_B_1 AND PS_SET_AR_H_POS AND PS_SET_C_AR );
	...
	MS_C_AR_GT_OUT_HP0B <= OUT_1A_D;
	MS_C_AR_GT_OUT_HP1B <= OUT_1C_A;
	MS_C_AR_GT_OUT_HP2B <= OUT_1E_D;
	MS_C_AR_GT_OUT_HP4B <= OUT_1G_A;
	MS_C_AR_GT_OUT_HP8B <= OUT_1I_D;
