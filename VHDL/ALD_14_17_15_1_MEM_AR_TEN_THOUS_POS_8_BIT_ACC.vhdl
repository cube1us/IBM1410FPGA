-- VHDL for IBM SMS ALD page 14.17.15.1
-- Title: MEM AR TEN THOUS POS 8 BIT-ACC
-- IBM Machine Name 1411
-- Generated by GenerateHDL at 8/22/2020 2:30:11 PM
...
entity ALD_14_17_15_1_MEM_AR_TEN_THOUS_POS_8_BIT_ACC is
	    Port (
		FPGA_CLK:		 in STD_LOGIC;
		PS_SET_MEM_AR_TO_I_AR:	 in STD_LOGIC;
		PS_SET_MEM_AR_2_GATED:	 in STD_LOGIC;
		PS_AR_BUS_TTHP8B:	 in STD_LOGIC;
		PS_SET_MEM_AR_1_GATED:	 in STD_LOGIC;
		PS_ADDR_SCNR_6_POS:	 in STD_LOGIC;
		MY_LOGIC_GATE_F_OR_W:	 in STD_LOGIC;
		MS_MEM_AR_TO_I_AR_TTHP8B:	 out STD_LOGIC;
		MS_AR_BUS_GTD_OUT_TTHP8B:	 out STD_LOGIC;
		PY_MEM_AR_TTHP8B_TO_MOD:	 out STD_LOGIC;
		MY_MEM_AR_TTHP8B:	 out STD_LOGIC;
		LAMP_11C8F05:	 out STD_LOGIC);
end ALD_14_17_15_1_MEM_AR_TEN_THOUS_POS_8_BIT_ACC;

architecture behavioral of ALD_14_17_15_1_MEM_AR_TEN_THOUS_POS_8_BIT_ACC is 
...
begin
	...
	OUT_5D_NoPin <= NOT PS_AR_BUS_TTHP8B;
	...
	OUT_5E_NoPin <= PS_AR_BUS_TTHP8B;
	OUT_4E_NoPin <= OUT_5E_NoPin AND PS_SET_MEM_AR_1_GATED;
	OUT_2E_C <= NOT OUT_2D_K;
	LAMP_11C8F05 <= OUT_2E_C;
	OUT_5F_C <= NOT(PS_ADDR_SCNR_6_POS AND PS_AR_BUS_TTHP8B );
	OUT_2F_R <= OUT_2D_K;
	OUT_1F_A <= NOT(OUT_2F_R OR MY_LOGIC_GATE_F_OR_W );

	MS_MEM_AR_TO_I_AR_TTHP8B <= OUT_1C_D;
	MS_AR_BUS_GTD_OUT_TTHP8B <= OUT_5F_C;
	MY_MEM_AR_TTHP8B <= OUT_2F_R;
	PY_MEM_AR_TTHP8B_TO_MOD <= OUT_1F_A;
