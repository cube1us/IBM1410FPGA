-- VHDL for IBM SMS ALD page 11.10.25.1
...
entity ALD_11_10_25_1_LOGIC_GATE_RING_EXTENSION_W is
	    Port (
...
end ALD_11_10_25_1_LOGIC_GATE_RING_EXTENSION_W;

architecture behavioral of ALD_11_10_25_1_LOGIC_GATE_RING_EXTENSION_W is 
...
begin
	...
	SMS_DEY_4C: entity SMS_DEY
	    port map (
		FPGA_CLK => FPGA_CLK,
		GATEON => PS_LOGIC_GATE_V,	-- Pin K
		ACSET => PS_LOGIC_RING_ON_ADVANCE_2,	-- Pin H
		GATEOFF => MS_LOGIC_GATE_V,	-- Pin E
	...
	MS_LOGIC_GATE_W <= OUT_3C_D;
	PS_LOGIC_GATE_W <= OUT_3D_C;
