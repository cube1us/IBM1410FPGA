-- VHDL for IBM SMS ALD page 18.14.04.1
...
entity ALD_18_14_04_1_OP_REGISTER_SET_CHECK is
	    Port (
...
end ALD_18_14_04_1_OP_REGISTER_SET_CHECK;

architecture behavioral of ALD_18_14_04_1_OP_REGISTER_SET_CHECK is 
...
begin
	...
	OUT_5F_B <= NOT MS_CHECK_OP_REG_SET;
	OUT_2G_C <= NOT OUT_1D_F;
	LAMP_15A1E20 <= OUT_2G_C;
	OUT_DOT_4A <= OUT_5B_D OR OUT_5A_F;
	OUT_DOT_4E <= OUT_5E_C OR OUT_5F_B;

	MS_OP_REG_SET_ERROR <= OUT_1D_F;
