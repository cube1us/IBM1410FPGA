...
-- Generated by GenerateHDL on 8/22/2020 5:29:12 PM
...
uut_process: process
   ...
   for marBit in 0 to 3 loop
      ...
      if marBit = 3 then
         check1(MY_MEM_AR_NOT_TTHP4B,'0',testName,"Bit " & INTEGER'IMAGE(marBit) & " B");
      end if;
      ...
      if marBit = 3 then
         check1(MY_MEM_AR_NOT_TTHP4B,'1',testName,"Bit " & INTEGER'IMAGE(marBit) & " K");
      end if;
