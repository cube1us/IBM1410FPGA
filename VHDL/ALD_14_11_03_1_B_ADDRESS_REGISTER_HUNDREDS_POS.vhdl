-- VHDL for IBM SMS ALD page 14.11.03.1
-- Title: B ADDRESS REGISTER HUNDREDS POS
-- IBM Machine Name 1411
-- Generated by GenerateHDL at 8/18/2020 1:27:24 PM
...
entity ALD_14_11_03_1_B_ADDRESS_REGISTER_HUNDREDS_POS is
	    Port (
		...
		MS_B_AR_GT_OUT_HP0B:	 out STD_LOGIC;
		MS_B_AR_GT_OUT_HP1B:	 out STD_LOGIC;
		MS_B_AR_GT_OUT_HP2B:	 out STD_LOGIC;
		MS_B_AR_GT_OUT_HP4B:	 out STD_LOGIC;
		MS_B_AR_GT_OUT_HP8B:	 out STD_LOGIC);
end ALD_14_11_03_1_B_ADDRESS_REGISTER_HUNDREDS_POS;

architecture behavioral of ALD_14_11_03_1_B_ADDRESS_REGISTER_HUNDREDS_POS is 
...
begin
	...
	OUT_5A_NoPin <= NOT(PS_ADDR_CH_0_B_1 AND PS_SET_AR_H_POS AND PS_SET_B_AR );
	...
	OUT_5C_NoPin <= NOT(PS_SET_AR_H_POS AND PS_ADDR_CH_1_B_1 AND PS_SET_B_AR );
	...
	OUT_5E_NoPin <= NOT(PS_ADDR_CH_2_B_1 AND PS_SET_AR_H_POS AND PS_SET_B_AR );
	...
	OUT_5G_NoPin <= NOT(PS_ADDR_CH_4_B_1 AND PS_SET_AR_H_POS AND PS_SET_B_AR );
	OUT_3G_NoPin_Latch <= NOT(MS_RESET_B_AR AND OUT_2G_NoPin );
	OUT_2G_NoPin_Latch <= NOT(OUT_5G_NoPin AND OUT_3G_NoPin );
	OUT_1G_D <= NOT(OUT_2G_NoPin AND PS_RO_B_AR );
	OUT_5I_NoPin <= NOT(PS_ADDR_CH_8_B_1 AND PS_SET_AR_H_POS AND PS_SET_B_AR );
	...
	MS_B_AR_GT_OUT_HP0B <= OUT_1A_D;
	MS_B_AR_GT_OUT_HP1B <= OUT_1C_A;
	MS_B_AR_GT_OUT_HP2B <= OUT_1E_4;
	MS_B_AR_GT_OUT_HP4B <= OUT_1G_D;
	MS_B_AR_GT_OUT_HP8B <= OUT_1I_9;
