-- VHDL for IBM SMS ALD page 18.13.01.1
-- Title: ASSEMBLY CHANNEL VALIDITY CHECK
-- IBM Machine Name 1411
-- Generated by GenerateHDL at 10/11/2020 8:35:15 PM
...
entity ALD_18_13_01_1_ASSEMBLY_CHANNEL_VALIDITY_CHECK is
	    Port (
		...
		MS_ASSEMBLY_CH_NOT_1_BIT:	 in STD_LOGIC;
		MS_ASSEMBLY_CH_NOT_8_BIT:	 in STD_LOGIC;
		MS_ASSEMBLY_CH_2_BIT:	 in STD_LOGIC;
		MS_ASSEMBLY_CH_4_BIT:	 in STD_LOGIC;
		MS_ASSEMBLY_CH_NOT_4_BIT:	 in STD_LOGIC;
		MS_ASSEMBLY_CH_NOT_2_BIT:	 in STD_LOGIC;
		PS_ASSEMBLY_CH_NUMERICS_ODD:	 out STD_LOGIC;
		PS_ASSEMBLY_CH_NUMERICS_EVEN:	 out STD_LOGIC);
end ALD_18_13_01_1_ASSEMBLY_CHANNEL_VALIDITY_CHECK;

architecture behavioral of ALD_18_13_01_1_ASSEMBLY_CHANNEL_VALIDITY_CHECK is 
...
begin
	...
	OUT_5B_NoPin <= MS_ASSEMBLY_CH_1_BIT AND MS_ASSEMBLY_CH_8_BIT;
	OUT_4B_B <= NOT(OUT_5B_NoPin OR OUT_5C_NoPin );
	OUT_2B_NoPin <= OUT_DOT_4B AND OUT_4F_B;
	OUT_1B_H <= NOT(OUT_2B_NoPin OR OUT_2C_NoPin );
	OUT_5C_NoPin <= MS_ASSEMBLY_CH_NOT_1_BIT AND MS_ASSEMBLY_CH_NOT_8_BIT;
	OUT_4C_C <= NOT(MV_1ST_CHECK_TEST_SWITCH );
	OUT_2C_NoPin <= OUT_DOT_4C AND OUT_4H_C;
	OUT_5D_NoPin <= MS_ASSEMBLY_CH_1_BIT AND MS_ASSEMBLY_CH_NOT_8_BIT;
	OUT_4D_C <= NOT(OUT_5D_NoPin OR OUT_5E_NoPin );
	OUT_1D_K <= NOT(MV_2ND_CHECK_TEST_SWITCH );
	OUT_5E_NoPin <= MS_ASSEMBLY_CH_8_BIT AND MS_ASSEMBLY_CH_NOT_1_BIT;
	OUT_2E_NoPin <= OUT_DOT_4B AND OUT_4H_C;
	OUT_1E_G <= NOT(OUT_2E_NoPin OR OUT_2F_NoPin );
	OUT_5F_NoPin <= MS_ASSEMBLY_CH_2_BIT AND MS_ASSEMBLY_CH_4_BIT;
	OUT_4F_B <= NOT(OUT_5F_NoPin OR OUT_5G_NoPin );
	OUT_2F_NoPin <= OUT_4F_B AND OUT_DOT_4C;
	OUT_5G_NoPin <= MS_ASSEMBLY_CH_NOT_4_BIT AND MS_ASSEMBLY_CH_NOT_2_BIT;
	OUT_5H_NoPin <= MS_ASSEMBLY_CH_2_BIT AND MS_ASSEMBLY_CH_NOT_4_BIT;
	OUT_4H_C <= NOT(OUT_5H_NoPin OR OUT_5I_NoPin );
	OUT_5I_NoPin <= MS_ASSEMBLY_CH_4_BIT AND MS_ASSEMBLY_CH_NOT_2_BIT;
	OUT_DOT_4B <= OUT_4A_G OR OUT_4B_B;
	OUT_DOT_1A <= OUT_1A_K OR OUT_1B_H;
	OUT_DOT_4C <= OUT_4C_C OR OUT_4D_C;
	OUT_DOT_1D <= OUT_1D_K OR OUT_1E_G;

	PS_ASSEMBLY_CH_NUMERICS_ODD <= OUT_DOT_1A;
	PS_ASSEMBLY_CH_NUMERICS_EVEN <= OUT_DOT_1D;
