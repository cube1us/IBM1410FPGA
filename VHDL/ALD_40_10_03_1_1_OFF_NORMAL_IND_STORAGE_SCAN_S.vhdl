...
begin
	...
	OUT_3D_K <= NOT SWITCH_ROT_ADDR_ENTRY(3);
	OUT_3D_D <= NOT SWITCH_ROT_ADDR_ENTRY(4);
	OUT_3D_F <= NOT SWITCH_ROT_ADDR_ENTRY(6);
	OUT_3D_G <= NOT SWITCH_ROT_ADDR_ENTRY(7);
	...
	OUT_5H_A <= NOT SWITCH_ROT_ADDR_ENTRY(1);
	OUT_5H_B <= NOT SWITCH_ROT_ADDR_ENTRY(2);
	OUT_5H_D <= NOT SWITCH_ROT_ADDR_ENTRY(4);
	OUT_5H_E <= NOT SWITCH_ROT_ADDR_ENTRY(5);
	OUT_5H_F <= NOT SWITCH_ROT_ADDR_ENTRY(6);
	OUT_5H_G <= NOT SWITCH_ROT_ADDR_ENTRY(7);
	OUT_4H_A <= OUT_DOT_4H;
	OUT_3H_X <= OUT_DOT_5H;
