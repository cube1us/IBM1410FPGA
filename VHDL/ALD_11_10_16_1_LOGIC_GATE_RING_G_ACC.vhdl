-- VHDL for IBM SMS ALD page 11.10.16.1
...
entity ALD_11_10_16_1_LOGIC_GATE_RING_G_ACC is
	    Port (
...
end ALD_11_10_16_1_LOGIC_GATE_RING_G_ACC;

architecture behavioral of ALD_11_10_16_1_LOGIC_GATE_RING_G_ACC is 
...
begin
	...
	LAMP_15A1G06 <= OUT_2A_E;

	SMS_DEY_4B: entity SMS_DEY
	    port map (
		FPGA_CLK => FPGA_CLK,
		GATEON => PS_LOGIC_GATE_F,	-- Pin K
		ACSET => PS_LOGIC_RING_ON_ADVANCE_1,	-- Pin H
		GATEOFF => MS_LOGIC_GATE_F,	-- Pin E
	...
	OUT_4E_B <= NOT OUT_5E_G;

	MS_LOGIC_GATE_G <= OUT_3B_D;
	PS_LOGIC_GATE_G <= OUT_3C_C;
