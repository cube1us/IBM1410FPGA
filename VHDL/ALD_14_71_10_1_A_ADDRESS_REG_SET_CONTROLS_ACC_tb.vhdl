...
uut_process: process
   ...
   SWITCH_ROT_ADDR_ENTRY(1) <= '1';
   wait for 30 ns;
   check1(PS_SET_A_AR,'0',testName,"1AA");
   SWITCH_ROT_ADDR_ENTRY(1) <= '0';
   ...
   SWITCH_ROT_ADDR_ENTRY(2) <= '0';
   SWITCH_ROT_ADDR_ENTRY(3) <= '1';
   wait for 30 ns;
   ...
   SWITCH_ROT_ADDR_ENTRY(3) <= '0';
   SWITCH_ROT_ADDR_ENTRY(4) <= '1';
   wait for 30 ns;
   ...
   SWITCH_ROT_ADDR_ENTRY(4) <= '0';
   SWITCH_ROT_ADDR_ENTRY(5) <= '1';
   wait for 30 ns;
   ...
   SWITCH_ROT_ADDR_ENTRY(5) <= '0';
   SWITCH_ROT_ADDR_ENTRY(6) <= '1';
   wait for 30 ns;
   ...
   SWITCH_ROT_ADDR_ENTRY(6) <= '0';
   SWITCH_ROT_ADDR_ENTRY(7) <= '1';
   wait for 30 ns;
