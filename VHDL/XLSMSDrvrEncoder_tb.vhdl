-- Test BenchVHDL for IBM SMS ALD group XLSMSDrvrEncoder
...
entity XLSMSDrvrEncoder_tb is
end XLSMSDrvrEncoder_tb;

architecture behavioral of XLSMSDrvrEncoder_tb is

	-- Component Declaration for the Unit Under Test (UUT)

	component XLSMSDrvrEncoder
	    Port (
	...
	signal MY_X_RD_2: STD_LOGIC := '1';
	signal MY_X_WR_2: STD_LOGIC := '1';
	signal MY_MEM_AR_NOT_UP_BUS: STD_LOGIC_VECTOR (4 downTo 0) := "11111";
	signal MY_MEM_AR_UP_BUS: STD_LOGIC_VECTOR (4 downTo 0) := "11111";

	-- Outputs

	signal PY_X_RD_2: STD_LOGIC;
	signal PY_X_LSMS_DRVR_BUS: STD_LOGIC_VECTOR (14 downTo 0);
...
-- END USER TEST BENCH DECLARATIONS
	...
	UUT: XLSMSDrvrEncoder port map(
		...
		PY_X_RD_2 => PY_X_RD_2,
		PY_X_LSMS_DRVR_BUS => PY_X_LSMS_DRVR_BUS);
   ...
   for rdwr in 0 to 1 loop
      for upos in 0 to 9 loop
         ...
         case rdwr is
		   ...
		   MY_MEM_AR_UP_BUS <= not BCD.twoOfFive(upos);
		   MY_MEM_AR_NOT_UP_BUS <= BCD.TwoOfFive(upos);
         ...
         wait for 30 ns;
		   ...
		   checkLSMSDrivers(PY_X_LSMS_DRVR_BUS,truthTableResults,testName,"X LSMS Driver for " &
		      Integer'image(upos) & ", rdwr: " & Integer'image(rdwr));
		      
         check1(PY_X_RD_2, not MY_X_RD_2, testName, "+Y X RD 2");		   
