...
architecture behavioral of ALD_40_10_01_1_CONSOLE_MODE_SWITCH is 
	...
	signal OUT_5E_M: STD_LOGIC;
	signal OUT_5E_N: STD_LOGIC;
...
begin
	...
	OUT_4B_X <= OUT_5C_K;
	OUT_5C_A <= NOT SWITCH_ROT_MODE_SW_DK(1);
	OUT_5C_B <= NOT SWITCH_ROT_MODE_SW_DK(2);
	OUT_5C_K <= NOT SWITCH_ROT_MODE_SW_DK(3);
	OUT_5C_D <= NOT SWITCH_ROT_MODE_SW_DK(4);
	OUT_5C_E <= NOT SWITCH_ROT_MODE_SW_DK(5);
	OUT_5C_E <= NOT SWITCH_ROT_MODE_SW_DK(5);
	OUT_5C_F <= NOT SWITCH_ROT_MODE_SW_DK(6);
	OUT_5C_G <= NOT SWITCH_ROT_MODE_SW_DK(7);
	OUT_5C_H <= NOT SWITCH_ROT_MODE_SW_DK(8);
	OUT_5C_J <= NOT SWITCH_ROT_MODE_SW_DK(9);
	OUT_5C_L <= NOT SWITCH_ROT_MODE_SW_DK(10);
	OUT_4C_X <= OUT_5C_E;
	OUT_4D_X <= OUT_5C_G;
	OUT_5E_M <= NOT SWITCH_ROT_MODE_SW_DK1(11);
	OUT_5E_N <= NOT SWITCH_ROT_MODE_SW_DK1(12);
	OUT_4F_X <= OUT_DOT_5D;
	OUT_4G_X <= OUT_5C_J;
	OUT_4H_X <= OUT_5E_M;
	OUT_DOT_5D <= OUT_5C_B AND OUT_5C_D AND OUT_5C_F AND OUT_5C_H AND OUT_5C_L AND OUT_5E_N;
