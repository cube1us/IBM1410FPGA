...
---- END USER TEST BENCH DECLARATIONS
	...
	IntegrationTest3FPGA: IntegrationTest3 port map(
		FPGA_CLK => CLK,
...
-- Instantiate the console typewriter
   ...
   port map(
      ...
      IBM1410_CONSOLE_INPUT_FIFO_WRITE_ENABLE => UART_INPUT_FIFO_WRITE_ENABLES(1),
...
-- Instantiate the Channel 1 TAU Adapter - try shorter time for cycle length....
   ...
   port map (
       ...
       IBM1410_TAU_INPUT_FIFO_WRITE_ENABLE => UART_INPUT_FIFO_WRITE_ENABLES(4),
...
-- Instantiate the Channel 2 TAU Adapter - try shorter time for cycle length....
   ...
   port map (
       ...
       IBM1410_TAU_INPUT_FIFO_WRITE_ENABLE => UART_INPUT_FIFO_WRITE_ENABLES(3),
       IBM1410_TAU_INPUT_FIFO_WRITE_DATA => UART_INPUT_FIFO_WRITE_DATA
   );
