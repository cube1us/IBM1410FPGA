...
--  end component uart_rx;
	...
	signal LAMP_VECTOR: STD_LOGIC_VECTOR (202 downTo 0);
...
-- Assign lamp vector from lamps for transmission to PC host
	...
	LAMP_VECTOR(129) <= LAMP_15A1K23;  -- 1401 MODE 12.65.10.1
	...
	LAMP_VECTOR(124) <= LAMP_15A2K03;  -- PRIO SW ON 19.10.01.1
	LAMP_VECTOR(123) <= LAMP_15A2K05;  -- PRIO SW ON 19.10.01.1
   ...
   SWITCH_VECTOR(49 downto 0)    <= "00000000000000000000000000000000000000000000000000";
	...
	SWITCH_MOM_2ND_TST_SW_PL1 <= SWITCH_VECTOR(272); -- 18.14.10.1
	SWITCH_MOM_3RD_TST_SW_PL1 <= SWITCH_VECTOR(271); -- 18.14.10.1
	SWITCH_MOM_ADDR_DISP <= SWITCH_VECTOR(270); -- 14.71.30.1
	...
	-- SWITCH_MOM_STARTPRINT <= SWITCH_VECTOR(261); -- 44.10.01.1
	-- SWITCH_REL_PWR_ON_RST <= SWITCH_VECTOR(260); -- 12.65.01.1
	SWITCH_REL_RTC_BUSY <= SWITCH_VECTOR(259); -- 14.15.23.1
	SWITCH_ROT_ADDR_ENTRY_DK1 <= SWITCH_VECTOR(258 downto 246); -- 40.10.03.1
	...
	SWITCH_TOG_AUTO_START_PL1 <= SWITCH_VECTOR(14); -- 40.10.03.1
	SWITCH_TOG_CH_1 <= SWITCH_VECTOR(13); -- 40.10.02.1
	SWITCH_TOG_CH_2 <= SWITCH_VECTOR(12); -- 40.10.02.1
	SWITCH_TOG_INHIBIT_PO_PL1 <= SWITCH_VECTOR(11); -- 40.10.03.1
	SWITCH_TOG_INHIBIT_PO_PL2 <= SWITCH_VECTOR(10); -- 44.10.01.1
	SWITCH_TOG_I_O_CHK_ST_PL1 <= SWITCH_VECTOR(9); -- 12.15.04.1
	SWITCH_TOG_SENSE_SW_1_PL1 <= SWITCH_VECTOR(8); -- 15.60.01.1
	SWITCH_TOG_SENSE_SW_2_PL1 <= SWITCH_VECTOR(7); -- 15.60.02.1
	SWITCH_TOG_SENSE_SW_4_PL1 <= SWITCH_VECTOR(6); -- 15.60.03.1
	SWITCH_TOG_SENSE_SW_8_PL1 <= SWITCH_VECTOR(5); -- 15.60.04.1
	SWITCH_TOG_SENSE_SW_A_PL1 <= SWITCH_VECTOR(4); -- 15.60.05.1
	SWITCH_TOG_SENSE_SW_B_PL1 <= SWITCH_VECTOR(3); -- 15.60.06.1
	SWITCH_TOG_SENSE_SW_C_PL1 <= SWITCH_VECTOR(2); -- 15.60.07.1
	SWITCH_TOG_SENSE_SW_W_PL1 <= SWITCH_VECTOR(1); -- 15.60.08.1
	SWITCH_TOG_WR_INHIBIT_PL1 <= SWITCH_VECTOR(0); -- 40.10.03.1
   ...
   LED(5) <= IBM1410_CONSOLE_XMT_STROBE;
