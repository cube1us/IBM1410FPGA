-- VHDL for IBM SMS ALD page 14.14.12.1
-- Title: E ADDRESS REGISTER HUNDREDS POS
-- IBM Machine Name 1411
-- Generated by GenerateHDL at 8/18/2020 4:57:01 PM
...
entity ALD_14_14_12_1_E_ADDRESS_REGISTER_HUNDREDS_POS is
	    Port (
		...
		MS_E_AR_GT_OUT_HP0B:	 out STD_LOGIC;
		MS_E_AR_GT_OUT_HP1B:	 out STD_LOGIC;
		MS_E_AR_GT_OUT_HP2B:	 out STD_LOGIC;
		MS_E_AR_GT_OUT_HP4B:	 out STD_LOGIC;
		MS_E_AR_GT_OUT_HP8B:	 out STD_LOGIC);
end ALD_14_14_12_1_E_ADDRESS_REGISTER_HUNDREDS_POS;

architecture behavioral of ALD_14_14_12_1_E_ADDRESS_REGISTER_HUNDREDS_POS is 
...
begin
	...
	OUT_5A_NoPin <= NOT(PS_ADDR_CH_0_B_1 AND PS_SET_AR_H_POS AND PS_SET_E_AR );
	...
	OUT_5C_NoPin <= NOT(PS_ADDR_CH_1_B_1 AND PS_SET_AR_H_POS AND PS_SET_E_AR );
	OUT_3C_NoPin_Latch <= NOT(MS_RESET_E_AR AND OUT_2C_NoPin );
	OUT_2C_NoPin_Latch <= NOT(OUT_5C_NoPin AND OUT_3C_NoPin );
	OUT_1C_4 <= NOT(OUT_2C_NoPin AND PS_RO_E_AR );
	OUT_5E_NoPin <= NOT(PS_ADDR_CH_2_B_1 AND PS_SET_AR_H_POS AND PS_SET_E_AR );
	OUT_3E_NoPin_Latch <= NOT(MS_RESET_E_AR AND OUT_2E_NoPin );
	OUT_2E_NoPin_Latch <= NOT(OUT_5E_NoPin AND OUT_3E_NoPin );
	OUT_1E_9 <= NOT(OUT_2E_NoPin AND PS_RO_E_AR );
	OUT_5G_NoPin <= NOT(PS_ADDR_CH_4_B_1 AND PS_SET_AR_H_POS AND PS_SET_E_AR );
	OUT_3G_NoPin_Latch <= NOT(MS_RESET_E_AR AND OUT_2G_NoPin );
	OUT_2G_NoPin_Latch <= NOT(OUT_5G_NoPin AND OUT_3G_NoPin );
	OUT_1G_4 <= NOT(OUT_2G_NoPin AND PS_RO_E_AR );
	OUT_5I_NoPin <= NOT(PS_SET_AR_H_POS AND PS_ADDR_CH_8_B_1 AND PS_SET_E_AR );
	...
	MS_E_AR_GT_OUT_HP0B <= OUT_1A_D;
	MS_E_AR_GT_OUT_HP1B <= OUT_1C_4;
	MS_E_AR_GT_OUT_HP2B <= OUT_1E_9;
	MS_E_AR_GT_OUT_HP4B <= OUT_1G_4;
	MS_E_AR_GT_OUT_HP8B <= OUT_1I_A;
