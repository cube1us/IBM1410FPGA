-- VHDL for IBM SMS ALD page 14.13.05.1
-- Title: D ADDRESS REGISTER TEN THOUSANDS
-- IBM Machine Name 1411
-- Generated by GenerateHDL at 8/18/2020 3:16:54 PM
...
entity ALD_14_13_05_1_D_ADDRESS_REGISTER_TEN_THOUSANDS is
	    Port (
		...
		MS_D_AR_GT_OUT_TTHP0B:	 out STD_LOGIC;
		MS_D_AR_GT_OUT_TTHP1B:	 out STD_LOGIC;
		MS_D_AR_GT_OUT_TTHP2B:	 out STD_LOGIC;
		MS_D_AR_GT_OUT_TTHP4B:	 out STD_LOGIC;
		MS_D_AR_GT_OUT_TTHP8B:	 out STD_LOGIC);
end ALD_14_13_05_1_D_ADDRESS_REGISTER_TEN_THOUSANDS;

architecture behavioral of ALD_14_13_05_1_D_ADDRESS_REGISTER_TEN_THOUSANDS is 
...
begin
	...
	OUT_5A_NoPin <= NOT(PS_ADDR_CH_0_B_1 AND PS_SET_AR_TTH_POS AND PS_SET_D_AR );
	...
	OUT_5C_NoPin <= NOT(PS_ADDR_CH_1_B_1 AND PS_SET_AR_TTH_POS AND PS_SET_D_AR );
	...
	OUT_5E_NoPin <= NOT(PS_ADDR_CH_2_B_1 AND PS_SET_AR_TTH_POS AND PS_SET_D_AR );
	...
	OUT_5G_NoPin <= NOT(PS_ADDR_CH_4_B_1 AND PS_SET_D_AR AND PS_SET_AR_TTH_POS );
	OUT_3G_NoPin_Latch <= NOT(MS_RESET_D_AR AND OUT_2G_NoPin );
	OUT_2G_NoPin_Latch <= NOT(OUT_5G_NoPin AND OUT_3G_NoPin );
	OUT_1G_A <= NOT(OUT_2G_NoPin AND PS_RO_D_AR );
	OUT_5I_NoPin <= NOT(PS_ADDR_CH_8_B_1 AND PS_SET_AR_TTH_POS AND PS_SET_D_AR );
	...
	MS_D_AR_GT_OUT_TTHP0B <= OUT_1A_4;
	MS_D_AR_GT_OUT_TTHP1B <= OUT_1C_9;
	MS_D_AR_GT_OUT_TTHP2B <= OUT_1E_4;
	MS_D_AR_GT_OUT_TTHP4B <= OUT_1G_A;
	MS_D_AR_GT_OUT_TTHP8B <= OUT_1I_9;
