-- VHDL for IBM SMS ALD page 14.14.20.1
-- Title: F ADDRESS REGISTER UNITS POS
-- IBM Machine Name 1411
-- Generated by GenerateHDL at 8/18/2020 5:12:23 PM
...
entity ALD_14_14_20_1_F_ADDRESS_REGISTER_UNITS_POS is
	    Port (
		...
		MS_F_AR_GT_OUT_UP0B:	 out STD_LOGIC;
		MS_F_AR_GT_OUT_UP1B:	 out STD_LOGIC;
		MS_F_AR_GT_OUT_UP2B:	 out STD_LOGIC;
		MS_F_AR_GT_OUT_UP4B:	 out STD_LOGIC;
		MS_F_AR_GT_OUT_UP8B:	 out STD_LOGIC);
end ALD_14_14_20_1_F_ADDRESS_REGISTER_UNITS_POS;

architecture behavioral of ALD_14_14_20_1_F_ADDRESS_REGISTER_UNITS_POS is 
...
begin
	...
	OUT_5A_NoPin <= NOT(PS_ADDR_CH_0_B_1 AND PS_SET_AR_U_POS AND PS_SET_F_AR );
	...
	OUT_5C_NoPin <= NOT(PS_SET_AR_U_POS AND PS_ADDR_CH_1_B_1 AND PS_SET_F_AR );
	...
	OUT_5E_NoPin <= NOT(PS_ADDR_CH_2_B_1 AND PS_SET_AR_U_POS AND PS_SET_F_AR );
	...
	OUT_5G_NoPin <= NOT(PS_SET_AR_U_POS AND PS_ADDR_CH_4_B_1 AND PS_SET_F_AR );
	...
	OUT_5I_NoPin <= NOT(PS_ADDR_CH_8_B_1 AND PS_SET_AR_U_POS AND PS_SET_F_AR );
	...
	MS_F_AR_GT_OUT_UP0B <= OUT_1A_D;
	MS_F_AR_GT_OUT_UP1B <= OUT_1C_A;
	MS_F_AR_GT_OUT_UP2B <= OUT_1E_D;
	MS_F_AR_GT_OUT_UP4B <= OUT_1G_A;
	MS_F_AR_GT_OUT_UP8B <= OUT_1I_D;
