...
uut_process: process
   ...
   PS_OP_MOD_REG_BUS(HDL_2_BIT) <= '1';
   MS_CMP_ZONE_UNEQUAL <= '0';
   wait for 30 ns;
   check1(PS_NO_BRANCH_CONDITIONS,'1',testName,"5F");
   MS_CMP_ZONE_UNEQUAL <= '1';   
   wait for 30 ns;
   PS_B_CYCLE <= '0';
   PS_1ST_SCAN <= '0';
   PS_ZN_OR_WM_TST_BRANCH_OP_CODE <= '0';   
   check1(PS_NO_BRANCH_CONDITIONS,'0',testName,"5G");
   PS_OP_MOD_REG_BUS(HDL_2_BIT) <= '0';
   
   MS_OVERLAP_CH_2_NO_BRANCH <= '1';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'0',testname,"6A");
   MS_OVERLAP_CH_2_NO_BRANCH <= '0';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'1',testname,"6B");
   MS_OVERLAP_CH_2_NO_BRANCH <= '1';
   ...
   PS_1ST_SCAN <= '1';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'0',testname,"7A");
   PS_1401_MODE <= '0';
   MS_1401_BRANCH_LATCH <= '0';
   MS_NO_BRANCH_LATCH <= '1';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'0',testname,"7B");
   MS_NO_BRANCH_LATCH <= '0';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'1',testname,"7C");
   MS_NO_BRANCH_LATCH <= '1';
   PS_1401_MODE <= '1';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'0',testname,"7D");
   MS_1401_BRANCH_LATCH <= '1';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'1',testname,"7E");
   PS_1ST_SCAN <= '0';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'0',testname,"7F");
   PS_1ST_SCAN <= '1';
   wait for 30 ns;
   PS_EVEN_HUNDREDS_ADDR <= '0';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'0',testname,"7G");
   PS_EVEN_HUNDREDS_ADDR <= '1';
   wait for 30 ns;
   PS_CLEAR_OP_CODE <= '0';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'0',testname,"7H");
   PS_CLEAR_OP_CODE <= '1';
   wait for 30 ns;
   PS_B_CYCLE <= '0';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'0',testname,"7I");
   PS_B_CYCLE <= '1';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'1',testname,"7J");
   ...
   PS_1401_MODE <= '0';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'0',testname,"8A");
   PS_ZN_OR_WM_TST_BRANCH_OP_CODE <= '1';
   PS_OP_MOD_REG_BUS(HDL_1_BIT) <= '1';
   PS_B_CH_WM_BIT_1 <= '1';
   MS_CMP_ZONE_UNEQUAL <= '1';
   PS_OP_MOD_REG_BUS(HDL_2_BIT) <= '1';   
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'0',testname,"8B");
   PS_OP_MOD_REG_BUS(HDL_1_BIT) <= '0';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'0',testname,"8C");
   PS_OP_MOD_REG_BUS(HDL_2_BIT) <= '0';   
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'1',testname,"8D");
   
   PS_OP_MOD_REG_BUS(HDL_2_BIT) <= '1';   
   PS_OP_MOD_REG_BUS(HDL_1_BIT) <= '1';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'0',testname,"8E");
   wait for 30 ns;
   PS_B_CH_WM_BIT_1 <= '0';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'0',testname,"8F");   
   MS_CMP_ZONE_UNEQUAL <= '0';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'1',testname,"8G");
      
   PS_B_CH_WM_BIT_1 <= '0'; -- Leave for the remaining tests of this gate set
   MS_CMP_ZONE_UNEQUAL <= '0'; -- Leave for the remaining tests of this gate set

   PS_ZN_OR_WM_TST_BRANCH_OP_CODE <= '0';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'0',testname,"8H");
   PS_ZN_OR_WM_TST_BRANCH_OP_CODE <= '1';
   wait for 30 ns;
   PS_1ST_SCAN <= '0';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'0',testname,"8I");
   PS_1ST_SCAN <= '1';
   wait for 30 ns;
   PS_B_CYCLE <= '0';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'0',testname,"8J");
   PS_B_CYCLE <= '1';   
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'1',testname,"8K");
   ...
   PS_OP_MOD_REG_BUS(HDL_1_BIT) <= '0';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'0',testName,"9A");
   check1(PS_NO_BRANCH_CONDITIONS,'0',testName,"9B");
   
   MS_NO_BRANCH_CND_INTERRUPT <= '0';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'1',testName,"9C");
   check1(PS_NO_BRANCH_CONDITIONS,'1',testName,"9D");
   MS_NO_BRANCH_CND_INTERRUPT <= '1';
   wait for 30 ns;
   MS_1401_NO_OP_DOT_LIROC <= '0';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'1',testName,"9E");
   check1(PS_NO_BRANCH_CONDITIONS,'0',testName,"9F");
   MS_1401_NO_OP_DOT_LIROC <= '1';
   wait for 30 ns;
   MS_1401_BRANCH_LAST_EX_CYCLE <= '0';
   wait for 30 ns;
   check1(PS_LAST_EXECUTE_CYCLE_STAR_BR_CND,'1',testName,"9G");
   check1(PS_NO_BRANCH_CONDITIONS,'0',testName,"9H");
   MS_1401_BRANCH_LAST_EX_CYCLE <= '1';
