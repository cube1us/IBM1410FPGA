...
-- Generated by GenerateHDL on 11/7/2020 1:25:39 PM
...
uut_process: process
   ...
   --   Verify these resets using the System Fundamentals Manual
   ...
   --   Edit to switch between CE and COnsole switches to verify
   
   SWITCH_MOM_CE_CPR_RST <= '1';
   wait for 500 us;
   SWITCH_MOM_CE_CPR_RST <= '0';
   wait for 30 ms;
   
   SWITCH_MOM_PROG_RESET <= '1';
   wait for 25 us;
   PS_STOPPED_AT_CYCLE_END <= '1';
   wait for 25 us;
   PS_STOPPED_DOT_NOT_IN_PROCESS <= '1';
   wait for 25 us;
   PS_STOPPED_AT_CYCLE_END <= '0';
   PS_STOPPED_DOT_NOT_IN_PROCESS <= '0';
   wait for 450 us;
   SWITCH_MOM_PROG_RESET <= '0';
   wait for 30 ms;
   
   testName := "12.65.04.1        ";
   
   check1(MS_START_RESET,'1',testName,"3A");
   MS_START_KEY_PULSE <= '0';
   PS_STOPPED_AT_CYCLE_END <= '1';
   wait for 30 ns;
   check1(MS_START_RESET,'0',testName,"3B");
   MS_START_KEY_PULSE <= '1';
   PS_STOPPED_AT_CYCLE_END <= '0';
   wait for 30 ns;
   
   testName := "12.65.10.1, 11.1  ";
  
   check1(PS_1401_MODE,'0',testName,"4A");
   check1(MS_1401_MODE,'1',testName,"4B");
   check1(PS_1401_MODE_1,'0',testName,"4C");
   check1(MS_1401_MODE_1,'1',testName,"4D");
   check1(MY_1401_MODE_1,'1',testName,"4E");
   check1(MC_1401_MODE_TO_1405,'1',testName,"4F");   

   SWITCH_TOG_1401_MODE_PL1 <= '1';
   wait for 30 ns;
   
   check1(PS_1401_MODE,'1',testName,"4G");
   check1(MS_1401_MODE,'0',testName,"4H");
   check1(PS_1401_MODE_1,'1',testName,"4I");
   check1(MS_1401_MODE_1,'0',testName,"4J");
   check1(MY_1401_MODE_1,'0',testName,"4K");
   check1(MC_1401_MODE_TO_1405,'0',testName,"4L");   
