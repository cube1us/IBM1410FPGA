-- VHDL for IBM SMS ALD page 14.17.10.1
-- Title: MEM AR THOUSANDS POS 0+1 BITS-ACC
-- IBM Machine Name 1411
-- Generated by GenerateHDL at 8/22/2020 2:17:29 PM
...
entity ALD_14_17_10_1_MEM_AR_THOUSANDS_POS_0_1_BITS_ACC is
	    Port (
		FPGA_CLK:		 in STD_LOGIC;
		PS_AR_BUS_THP0B:	 in STD_LOGIC;
		...
		PS_AR_BUS_THP1B:	 in STD_LOGIC;
		MS_MEM_AR_TO_I_AR_THP0B:	 out STD_LOGIC;
		MY_MEM_AR_NOT_THP0B:	 out STD_LOGIC;
		MS_AR_BUS_GTD_OUT_THP0B:	 out STD_LOGIC;
		PY_MEM_AR_THP0B_TO_ADDR_MOD:	 out STD_LOGIC;
		MY_MEM_AR_THP0B:	 out STD_LOGIC;
		MS_MEM_AR_TO_I_AR_THP1B:	 out STD_LOGIC;
		MY_MEM_AR_NOT_THP1B:	 out STD_LOGIC;
		MS_AR_BUS_GTD_OUT_THP1B:	 out STD_LOGIC;
		PY_MEM_AR_THP1B_TO_ADDR_MOD:	 out STD_LOGIC;
		MY_MEM_AR_THP1B:	 out STD_LOGIC;
		LAMP_11C8K04:	 out STD_LOGIC;
		LAMP_11C8J04:	 out STD_LOGIC);
end ALD_14_17_10_1_MEM_AR_THOUSANDS_POS_0_1_BITS_ACC;

architecture behavioral of ALD_14_17_10_1_MEM_AR_THOUSANDS_POS_0_1_BITS_ACC is 
...
begin
	...
	OUT_5B_NoPin <= NOT PS_AR_BUS_THP0B;
	...
	OUT_5C_NoPin <= PS_AR_BUS_THP0B;
	OUT_4C_NoPin <= OUT_5C_NoPin AND PS_SET_MEM_AR_1_GATED;
	OUT_2C_A <= NOT OUT_2B_K;
	LAMP_11C8K04 <= OUT_2C_A;
	OUT_5D_C <= NOT(PS_ADDR_SCNR_5_POS AND PS_AR_BUS_THP0B );
	OUT_2D_R <= OUT_2B_K;
	OUT_1D_A <= NOT(OUT_2D_R OR MY_LOGIC_GATE_E_OR_V );
	OUT_1F_D <= NOT(PS_SET_MEM_AR_TO_I_AR AND OUT_3G_NoPin );
	OUT_5G_NoPin <= NOT PS_AR_BUS_THP1B;
	...
	OUT_5H_NoPin <= PS_AR_BUS_THP1B;
	OUT_4H_NoPin <= OUT_5H_NoPin AND PS_SET_MEM_AR_1_GATED;
	OUT_2H_D <= NOT OUT_2G_K;
	LAMP_11C8J04 <= OUT_2H_D;
	OUT_5I_C <= NOT(PS_ADDR_SCNR_5_POS AND PS_AR_BUS_THP1B );
	OUT_2I_R <= OUT_2G_K;
	OUT_1I_A <= NOT(OUT_2I_R OR MY_LOGIC_GATE_E_OR_V );

	MS_MEM_AR_TO_I_AR_THP0B <= OUT_1A_D;
	MY_MEM_AR_NOT_THP0B <= OUT_1B_E;
	MS_AR_BUS_GTD_OUT_THP0B <= OUT_5D_C;
	MY_MEM_AR_THP0B <= OUT_2D_R;
	PY_MEM_AR_THP0B_TO_ADDR_MOD <= OUT_1D_A;
	MS_MEM_AR_TO_I_AR_THP1B <= OUT_1F_D;
	MY_MEM_AR_NOT_THP1B <= OUT_1G_E;
	MS_AR_BUS_GTD_OUT_THP1B <= OUT_5I_C;
	MY_MEM_AR_THP1B <= OUT_2I_R;
	PY_MEM_AR_THP1B_TO_ADDR_MOD <= OUT_1I_A;
