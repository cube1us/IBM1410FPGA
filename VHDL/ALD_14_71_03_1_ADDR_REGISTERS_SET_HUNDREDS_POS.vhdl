-- VHDL for IBM SMS ALD page 14.71.03.1
-- Title: ADDR REGISTERS SET HUNDREDS POS
-- IBM Machine Name 1411
-- Generated by GenerateHDL at 9/4/2020 12:50:20 PM
...
entity ALD_14_71_03_1_ADDR_REGISTERS_SET_HUNDREDS_POS is
	    Port (
...
end ALD_14_71_03_1_ADDR_REGISTERS_SET_HUNDREDS_POS;

architecture behavioral of ALD_14_71_03_1_ADDR_REGISTERS_SET_HUNDREDS_POS is 
...
begin
	...
	OUT_5B_NoPin <= NOT(PS_I_RING_3_OR_8_TIME AND PS_I_CYCLE AND PS_LOGIC_GATE_A_OR_R );
	OUT_3B_4 <= NOT PS_2ND_CLOCK_PULSE_4;
	OUT_5C_NoPin <= NOT(PS_X_CYCLE AND PS_A_RING_4_TIME AND PS_LOGIC_GATE_H );
	OUT_4C_C <= NOT(OUT_5B_NoPin AND OUT_5C_NoPin AND MS_LOGIC_GATE_D_1 );
	...
	OUT_4D_K <= NOT(MS_LOGIC_GATE_U );
	OUT_4E_NoPin <= NOT(PS_CONS_CLOCK_2_POS AND PS_CONS_MX_Y3_POS AND PS_CONSOLE_STROBE_GTD );
	OUT_2E_Y <= NOT OUT_4E_NoPin;
	OUT_DOT_4C <= OUT_4C_C OR OUT_4D_K;
	OUT_DOT_3C <= OUT_3B_4 OR OUT_3C_3;

	PS_SET_AR_H_POS <= OUT_2C_A;
