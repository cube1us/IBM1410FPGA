...
begin
	...
	OUT_5A_T <=  NOT SWITCH_ALT_PRIORITY_L;
	LAMP_15A2K03 <= OUT_5A_T;
	LAMP_15A2K05 <= OUT_5A_T;
	OUT_5B_N <= SWITCH_ALT_PRIORITY;
	OUT_5B_T <=  NOT SWITCH_ALT_PRIORITY;
	OUT_4B_X <= OUT_5B_N;
	...
	OUT_5E_B <= NOT SWITCH_ROT_I_O_UNIT(2);
	OUT_5E_K <= NOT SWITCH_ROT_I_O_UNIT(3);
	OUT_5E_D <= NOT SWITCH_ROT_I_O_UNIT(4);
	OUT_5E_E <= NOT SWITCH_ROT_I_O_UNIT(5);
	OUT_4E_X <= OUT_5E_K;
