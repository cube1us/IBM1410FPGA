-- VHDL for IBM SMS ALD page 14.10.04.1
-- Title: A ADDRESS REGISTER THOUSANDS POS
-- IBM Machine Name 1411
-- Generated by GenerateHDL at 8/18/2020 11:13:26 AM
...
entity ALD_14_10_04_1_A_ADDRESS_REGISTER_THOUSANDS_POS is
	    Port (
		...
		MS_A_AR_GT_OUT_THP0B:	 out STD_LOGIC;
		MS_A_AR_GT_OUT_THP1B:	 out STD_LOGIC;
		MS_A_AR_GT_OUT_THP2B:	 out STD_LOGIC;
		MS_A_AR_GT_OUT_THP4B:	 out STD_LOGIC;
		MS_A_AR_GT_OUT_THP8B:	 out STD_LOGIC);
end ALD_14_10_04_1_A_ADDRESS_REGISTER_THOUSANDS_POS;

architecture behavioral of ALD_14_10_04_1_A_ADDRESS_REGISTER_THOUSANDS_POS is 
...
begin
	...
	OUT_5A_NoPin <= NOT(PS_ADDR_CH_0_B_1 AND PS_SET_AR_TH_POS AND PS_SET_A_AR );
	OUT_3A_NoPin_Latch <= NOT(MS_RESET_A_AR AND OUT_2A_NoPin );
	OUT_2A_NoPin_Latch <= NOT(OUT_5A_NoPin AND OUT_3A_NoPin );
	OUT_1A_9 <= NOT(OUT_2A_NoPin AND PS_RO_A_AR );
	OUT_5C_NoPin <= NOT(PS_ADDR_CH_1_B_1 AND PS_SET_AR_TH_POS AND PS_SET_A_AR );
	OUT_3C_NoPin_Latch <= NOT(MS_RESET_A_AR AND OUT_2C_NoPin );
	OUT_2C_NoPin_Latch <= NOT(OUT_5C_NoPin AND OUT_3C_NoPin );
	OUT_1C_4 <= NOT(OUT_2C_NoPin AND PS_RO_A_AR );
	OUT_5E_NoPin <= NOT(PS_ADDR_CH_2_B_1 AND PS_SET_AR_TH_POS AND PS_SET_A_AR );
	OUT_3E_NoPin_Latch <= NOT(MS_RESET_A_AR AND OUT_2E_NoPin );
	OUT_2E_NoPin_Latch <= NOT(OUT_5E_NoPin AND OUT_3E_NoPin );
	OUT_1E_9 <= NOT(OUT_2E_NoPin AND PS_RO_A_AR );
	OUT_5G_NoPin <= NOT(PS_ADDR_CH_4_B_1 AND PS_SET_AR_TH_POS AND PS_SET_A_AR );
	OUT_3G_NoPin_Latch <= NOT(MS_RESET_A_AR AND OUT_2G_NoPin );
	OUT_2G_NoPin_Latch <= NOT(OUT_5G_NoPin AND OUT_3G_NoPin );
	OUT_1G_4 <= NOT(OUT_2G_NoPin AND PS_RO_A_AR );
	OUT_5I_NoPin <= NOT(PS_ADDR_CH_8_B_1 AND PS_SET_AR_TH_POS AND PS_SET_A_AR );
	...
	MS_A_AR_GT_OUT_THP0B <= OUT_1A_9;
	MS_A_AR_GT_OUT_THP1B <= OUT_1C_4;
	MS_A_AR_GT_OUT_THP2B <= OUT_1E_9;
	MS_A_AR_GT_OUT_THP4B <= OUT_1G_4;
	MS_A_AR_GT_OUT_THP8B <= OUT_1I_9;
