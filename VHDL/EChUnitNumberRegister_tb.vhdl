-- Test BenchVHDL for IBM SMS ALD group EChUnitNumberRegister
...
entity EChUnitNumberRegister_tb is
end EChUnitNumberRegister_tb;

architecture behavioral of EChUnitNumberRegister_tb is

	-- Component Declaration for the Unit Under Test (UUT)

	component EChUnitNumberRegister
	    Port (
	...
	signal PS_E_CH_U_NU_REG_NOT_BUS: STD_LOGIC_VECTOR (7 downTo 0);
	signal PS_E_CH_U_NU_REG_BUS: STD_LOGIC_VECTOR (7 downTo 0);
...
-- END USER TEST BENCH DECLARATIONS
	...
	UUT: EChUnitNumberRegister port map(
		FPGA_CLK => FPGA_CLK,
