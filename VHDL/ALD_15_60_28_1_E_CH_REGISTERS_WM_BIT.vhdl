-- VHDL for IBM SMS ALD page 15.60.28.1
-- Title: E CH REGISTERS WM BIT
-- IBM Machine Name 1411
-- Generated by GenerateHDL at 9/18/2020 5:45:13 PM
...
entity ALD_15_60_28_1_E_CH_REGISTERS_WM_BIT is
	    Port (
		FPGA_CLK:		 in STD_LOGIC;
		MS_E1_INPUT_WM_BIT:	 in STD_LOGIC;
		PS_SET_E1_REG:	 in STD_LOGIC;
		PS_E1_INPUT_WM_BIT:	 in STD_LOGIC;
		...
		PS_E2_REG_WM_BIT:	 out STD_LOGIC;
		MS_E2_REG_WM_BIT:	 out STD_LOGIC);
end ALD_15_60_28_1_E_CH_REGISTERS_WM_BIT;

architecture behavioral of ALD_15_60_28_1_E_CH_REGISTERS_WM_BIT is 
...
begin
	...
	OUT_4B_NoPin <= NOT(MS_E1_INPUT_WM_BIT AND PS_SET_E1_REG );
	OUT_3B_C_Latch <= NOT(OUT_4B_NoPin AND OUT_2B_D );
	OUT_2B_D_Latch <= NOT(OUT_3B_C AND OUT_4C_Q );
	OUT_1B_D <= NOT OUT_2B_D;
	OUT_4C_Q <= NOT(PS_SET_E1_REG AND PS_E1_INPUT_WM_BIT );
	OUT_2C_C <= NOT OUT_3B_C;
	OUT_4E_F <= NOT(OUT_1B_D AND PS_COPY_E1_WM_DOT_C_BIT AND PS_SET_E2_REG );
	OUT_4F_E <= NOT(OUT_2C_C AND PS_SET_E2_REG AND PS_COPY_INV_E1_WM_DOT_C_BIT );
	OUT_3F_P <= NOT(OUT_4E_F AND OUT_4F_E );
	OUT_1F_C <= NOT OUT_DOT_3F;
	OUT_4G_D <= NOT(OUT_2C_C AND PS_SET_E2_REG AND PS_COPY_E1_WM_DOT_C_BIT );
	OUT_3G_P_Latch <= NOT(MS_SET_E2_WORD_SEPARATOR AND OUT_2G_NoPin );
	OUT_2G_NoPin_Latch <= NOT(OUT_4G_D AND OUT_DOT_3F AND OUT_4H_C );
	OUT_1G_B <= NOT OUT_2G_NoPin;
	OUT_4H_C <= NOT(OUT_1B_D AND PS_SET_E2_REG AND PS_COPY_INV_E1_WM_DOT_C_BIT );
	OUT_DOT_3F <= OUT_3F_P OR OUT_3G_P;

	PS_E1_REG_NOT_WM_BIT <= OUT_1B_D;
	PS_E1_REG_WM_BIT <= OUT_2C_C;
	PS_E2_REG_WM_BIT <= OUT_1F_C;
	MS_E2_REG_WM_BIT <= OUT_1G_B;
