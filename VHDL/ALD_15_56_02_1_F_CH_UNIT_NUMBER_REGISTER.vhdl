-- VHDL for IBM SMS ALD page 15.56.02.1
-- Title: F CH UNIT NUMBER REGISTER
-- IBM Machine Name 1411
-- Generated by GenerateHDL at 9/17/2020 4:24:31 PM
...
entity ALD_15_56_02_1_F_CH_UNIT_NUMBER_REGISTER is
	    Port (
		FPGA_CLK:		 in STD_LOGIC;
		PS_ASSEMBLY_CH_2_BIT:	 in STD_LOGIC;
		MS_F_CH_RESET:	 in STD_LOGIC;
		PS_SET_F_CH_UNIT_NU_REG:	 in STD_LOGIC;
		PS_ASSEMBLY_CH_1_BIT:	 in STD_LOGIC;
		PS_F_CH_UNIT_NU_REG_NOT_2_BIT:	 out STD_LOGIC;
		PS_F_CH_UNIT_NU_REG_2_BIT:	 out STD_LOGIC;
		PS_F_CH_UNIT_NU_REG_NOT_1_BIT:	 out STD_LOGIC;
		PS_F_CH_UNIT_NU_REG_1_BIT:	 out STD_LOGIC);
end ALD_15_56_02_1_F_CH_UNIT_NUMBER_REGISTER;

architecture behavioral of ALD_15_56_02_1_F_CH_UNIT_NUMBER_REGISTER is 
...
begin
	...
	OUT_4C_F_Latch <= NOT(MS_F_CH_RESET AND OUT_3C_NoPin );
	OUT_3C_NoPin_Latch <= NOT(OUT_4C_F AND OUT_5D_C );
	OUT_2C_E <= NOT OUT_3C_NoPin;
	OUT_5D_C <= NOT(PS_ASSEMBLY_CH_2_BIT AND PS_SET_F_CH_UNIT_NU_REG );
	...
	OUT_5F_R <= NOT(PS_SET_F_CH_UNIT_NU_REG AND PS_ASSEMBLY_CH_1_BIT );
	OUT_2F_D <= NOT OUT_4E_F;

	PS_F_CH_UNIT_NU_REG_NOT_2_BIT <= OUT_2C_E;
	PS_F_CH_UNIT_NU_REG_2_BIT <= OUT_2D_D;
	PS_F_CH_UNIT_NU_REG_NOT_1_BIT <= OUT_2E_E;
	PS_F_CH_UNIT_NU_REG_1_BIT <= OUT_2F_D;
