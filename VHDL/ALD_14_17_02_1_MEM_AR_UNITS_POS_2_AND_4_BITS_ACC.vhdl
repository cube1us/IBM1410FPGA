-- VHDL for IBM SMS ALD page 14.17.02.1
-- Title: MEM AR UNITS POS 2 AND 4 BITS-ACC
-- IBM Machine Name 1411
-- Generated by GenerateHDL at 8/22/2020 2:16:53 PM
...
entity ALD_14_17_02_1_MEM_AR_UNITS_POS_2_AND_4_BITS_ACC is
	    Port (
		FPGA_CLK:		 in STD_LOGIC;
		PS_AR_BUS_UP2B:	 in STD_LOGIC;
		...
		PS_AR_BUS_UP4B:	 in STD_LOGIC;
		MS_MEM_AR_TO_I_AR_UP2B:	 out STD_LOGIC;
		MY_MEM_AR_NOT_UP2B:	 out STD_LOGIC;
		MS_AR_BUS_GTD_OUT_UP2B:	 out STD_LOGIC;
		PY_MEM_AR_UP2B_TO_ADDR_MOD:	 out STD_LOGIC;
		MY_MEM_AR_UP2B:	 out STD_LOGIC;
		MS_MEM_AR_TO_I_AR_UP4B:	 out STD_LOGIC;
		MY_MEM_AR_NOT_UP4B:	 out STD_LOGIC;
		MS_AR_BUS_GTD_OUT_UP4B:	 out STD_LOGIC;
		PY_MEM_AR_UP4B_TO_ADDR_MOD:	 out STD_LOGIC;
		MY_MEM_AR_UP4B:	 out STD_LOGIC;
		LAMP_11C8H01:	 out STD_LOGIC;
		LAMP_11C8G01:	 out STD_LOGIC);
end ALD_14_17_02_1_MEM_AR_UNITS_POS_2_AND_4_BITS_ACC;

architecture behavioral of ALD_14_17_02_1_MEM_AR_UNITS_POS_2_AND_4_BITS_ACC is 
...
begin
	...
	OUT_5B_NoPin <= NOT PS_AR_BUS_UP2B;
	...
	OUT_5C_NoPin <= PS_AR_BUS_UP2B;
	OUT_4C_NoPin <= OUT_5C_NoPin AND PS_SET_MEM_AR_1_GATED;
	OUT_2C_B <= NOT OUT_2B_K;
	LAMP_11C8H01 <= OUT_2C_B;
	OUT_5D_C <= NOT(PS_ADDR_SCNR_2_POS AND PS_AR_BUS_UP2B );
	OUT_2D_R <= OUT_2B_K;
	OUT_1D_A <= NOT(OUT_2D_R OR MY_LOGIC_GATE_B_OR_S );
	OUT_1F_D <= NOT(PS_SET_MEM_AR_TO_I_AR AND OUT_3G_NoPin );
	OUT_5G_NoPin <= NOT PS_AR_BUS_UP4B;
	...
	OUT_5H_NoPin <= PS_AR_BUS_UP4B;
	OUT_4H_NoPin <= OUT_5H_NoPin AND PS_SET_MEM_AR_1_GATED;
	OUT_2H_A <= NOT OUT_2G_K;
	LAMP_11C8G01 <= OUT_2H_A;
	OUT_5I_C <= NOT(PS_ADDR_SCNR_2_POS AND PS_AR_BUS_UP4B );
	OUT_2I_R <= OUT_2G_K;
	OUT_1I_A <= NOT(OUT_2I_R OR MY_LOGIC_GATE_B_OR_S );

	MS_MEM_AR_TO_I_AR_UP2B <= OUT_1A_D;
	MY_MEM_AR_NOT_UP2B <= OUT_1B_E;
	MS_AR_BUS_GTD_OUT_UP2B <= OUT_5D_C;
	MY_MEM_AR_UP2B <= OUT_2D_R;
	PY_MEM_AR_UP2B_TO_ADDR_MOD <= OUT_1D_A;
	MS_MEM_AR_TO_I_AR_UP4B <= OUT_1F_D;
	MY_MEM_AR_NOT_UP4B <= OUT_1G_E;
	MS_AR_BUS_GTD_OUT_UP4B <= OUT_5I_C;
	MY_MEM_AR_UP4B <= OUT_2I_R;
	PY_MEM_AR_UP4B_TO_ADDR_MOD <= OUT_1I_A;
