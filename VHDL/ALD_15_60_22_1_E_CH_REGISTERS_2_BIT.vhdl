-- VHDL for IBM SMS ALD page 15.60.22.1
-- Title: E CH REGISTERS 2 BIT
-- IBM Machine Name 1411
-- Generated by GenerateHDL at 9/18/2020 5:45:02 PM
...
entity ALD_15_60_22_1_E_CH_REGISTERS_2_BIT is
	    Port (
		...
		MS_E2_REG_2_BIT:	 out STD_LOGIC;
		PS_E2_REG_2_BIT:	 out STD_LOGIC);
end ALD_15_60_22_1_E_CH_REGISTERS_2_BIT;

architecture behavioral of ALD_15_60_22_1_E_CH_REGISTERS_2_BIT is 
...
begin
	...
	OUT_4B_NoPin <= NOT(MS_E1_INPUT_2_BIT AND PS_SET_E1_REG );
	OUT_3B_C_Latch <= NOT(OUT_4B_NoPin AND OUT_2B_D );
	OUT_2B_D_Latch <= NOT(OUT_3B_C AND OUT_4C_G );
	OUT_4C_G <= NOT(PS_E1_INPUT_2_BIT AND PS_SET_E1_REG );
	...
	MS_E2_REG_2_BIT <= OUT_1F_E;
	PS_E2_REG_2_BIT <= OUT_1G_D;
