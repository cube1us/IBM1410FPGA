...
-- Generated by GenerateHDL at 11/18/2020 2:25:12 PM
...
begin
	...
	OUT_2H_A <= NOT SWITCH_ROT_ADDR_SEL_DK1(1);
	OUT_2H_B <= NOT SWITCH_ROT_ADDR_SEL_DK1(2);
	OUT_2H_K <= NOT SWITCH_ROT_ADDR_SEL_DK1(3);
	OUT_2H_D <= NOT SWITCH_ROT_ADDR_SEL_DK1(4);
	OUT_2H_E <= NOT SWITCH_ROT_ADDR_SEL_DK1(5);
	OUT_2H_F <= NOT SWITCH_ROT_ADDR_SEL_DK1(6);
	OUT_2H_G <= NOT SWITCH_ROT_ADDR_SEL_DK1(7);
	OUT_5I_T <=  NOT SWITCH_MOM_ADDR_DISP;
	OUT_4I_X <= OUT_5I_T;
	OUT_DOT_5A <= OUT_5A_K OR OUT_5B_F OR OUT_4B_R;
	-- OUT_DOT_4C <= OUT_4C_F OR OUT_4F_D OR OUT_4G_P;
	OUT_DOT_4C <= OUT_4C_F OR OUT_4F_D OR OUT_4G_P OR 
	   (PS_1401_STORE_A_AR_OP_CODE AND PS_1401_MODE_1 AND PS_B_CYCLE_CTRL);
	...
	PS_RO_A_AR <= OUT_1C_G;
	-- PS_RO_A_AR <= OUT_1C_G OR (PS_1401_STORE_A_AR_OP_CODE AND PS_1401_MODE_1 AND PS_B_CYCLE_CTRL);
