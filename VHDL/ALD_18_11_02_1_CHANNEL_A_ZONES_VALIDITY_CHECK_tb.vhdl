-- Test Bench VHDL for IBM SMS ALD page 18.11.02.1
...
entity ALD_18_11_02_1_CHANNEL_A_ZONES_VALIDITY_CHECK_tb is
end ALD_18_11_02_1_CHANNEL_A_ZONES_VALIDITY_CHECK_tb;

architecture behavioral of ALD_18_11_02_1_CHANNEL_A_ZONES_VALIDITY_CHECK_tb is

	-- Component Declaration for the Unit Under Test (UUT)

	component ALD_18_11_02_1_CHANNEL_A_ZONES_VALIDITY_CHECK
	    Port (
	...
	signal PS_A_CH_C_BIT: STD_LOGIC := '0';
	signal PS_A_CH_NOT_C_BIT: STD_LOGIC := '0';
...
-- END USER TEST BENCH DECLARATIONS
	...
	UUT: ALD_18_11_02_1_CHANNEL_A_ZONES_VALIDITY_CHECK port map(
		FPGA_CLK => FPGA_CLK,
		...
		PS_A_CH_C_BIT => PS_A_CH_C_BIT,
		PS_A_CH_NOT_C_BIT => PS_A_CH_NOT_C_BIT,
...
uut_process: process
   ...
   for tt in 0 to 2**9 loop
      ...
      g1 := (b and e) nor (c and d);
      g2 := (d and b) nor (c and e);
      g3 := (f and j) nor (g and h);
      g4 := (f and h) nor (j and g);

		MV_3RD_CHECK_TEST_SWITCH <= not a;
		PS_A_CH_A_BIT <= b;
		PS_A_CH_NOT_A_BIT <= c;
		PS_A_CH_NOT_B_BIT <= d;
		PS_A_CH_B_BIT <= e;
		PS_A_CH_C_BIT <= f;
		PS_A_CH_NOT_C_BIT <= g;
		PS_A_CH_NOT_WM_BIT <= h;
		PS_A_CH_WM_BIT <= j;
      
      wait for 30 ns;
      
      check1(PS_A_CH_VC_NOT_ZONE_C_BIT,g1,testName,"A Ch VC Not Zone C Bit");
      check1(PS_A_CH_VC_NU_C_BIT,((g1 and g3) nor (g2 and g4)) or a,testName,"A Ch VC Nu C Bit");
      check1(PS_A_CH_VC_ZONE_C_BIT,g2,testName,"A Ch VC Zone C Bit");
      check1(PS_A_CH_VC_NOT_NU_C_BIT,((g3 and g2) nor (g4 and g1)) or a,testName,
         "A Ch VC Not Nu C Bit");      
