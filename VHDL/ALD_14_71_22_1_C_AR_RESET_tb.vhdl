-- Test Bench VHDL for IBM SMS ALD page 14.71.22.1
-- Title: C AR RESET
...
entity ALD_14_71_22_1_C_AR_RESET_tb is
end ALD_14_71_22_1_C_AR_RESET_tb;

architecture behavioral of ALD_14_71_22_1_C_AR_RESET_tb is

	-- Component Declaration for the Unit Under Test (UUT)

	component ALD_14_71_22_1_C_AR_RESET
	    Port (
	...
	signal MS_RESET_C_AR_1: STD_LOGIC := '1';
...
-- END USER TEST BENCH DECLARATIONS
	...
	UUT: ALD_14_71_22_1_C_AR_RESET port map(
		FPGA_CLK => FPGA_CLK,
...
uut_process: process
   ...
   for t in 0 to 1024 loop
      ...
      PS_C_CYCLE_CTRL <= a;
      PS_LOGIC_GATE_EARLY_B <= b;
      MS_SYSTEM_RESET <= not c;
      PS_SET_C_AR <= d;
      PS_CONSOLE_CYCLE_START <= e;
      MS_RESET_C_AR_1 <= not f;
      PS_1ST_CLOCK_PULSE_1 <= g;
      PS_I_RING_1_OR_1401_AND_3_TIME <= h;
      PS_LOGIC_GATE_EARLY_F <= i;
      PS_STORE_ADDR_REGS_OP_CODE <= j;
      wait for 30 ns;
  
      g1 := h and i and j;
      
      check1(MS_RESET_C_AR,NOT(g and (c or (a and b) or f or (d and e) or g1)),testName,"Reset C AR");
      check1(MS_RESET_D_AR_3,NOT g1,testName,"Reset D AR 3");
