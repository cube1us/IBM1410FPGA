...
begin
	...
	OUT_2F_X <= OUT_5G_B;
	OUT_5G_A <= NOT SWITCH_ROT_ADDR_ENTRY_DK3(1);
	OUT_5G_B <= NOT SWITCH_ROT_ADDR_ENTRY_DK3(2);
	OUT_5G_K <= NOT SWITCH_ROT_ADDR_ENTRY_DK3(3);
	OUT_5G_D <= NOT SWITCH_ROT_ADDR_ENTRY_DK3(4);
	OUT_5G_E <= NOT SWITCH_ROT_ADDR_ENTRY_DK3(5);
	OUT_5G_E <= NOT SWITCH_ROT_ADDR_ENTRY_DK3(5);
	OUT_5G_F <= NOT SWITCH_ROT_ADDR_ENTRY_DK3(6);
	OUT_5G_G <= NOT SWITCH_ROT_ADDR_ENTRY_DK3(7);
	OUT_4G_X <= OUT_5G_K;
	OUT_2G_X <= OUT_5G_D;
	OUT_4H_X <= OUT_5G_E;
	OUT_2H_X <= OUT_5G_E;
