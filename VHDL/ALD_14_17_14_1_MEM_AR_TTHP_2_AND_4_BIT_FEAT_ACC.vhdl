-- VHDL for IBM SMS ALD page 14.17.14.1
-- Title: MEM AR TTHP 2 AND 4 BIT FEAT-ACC
-- IBM Machine Name 1411
-- Generated by GenerateHDL at 8/22/2020 5:28:25 PM
...
entity ALD_14_17_14_1_MEM_AR_TTHP_2_AND_4_BIT_FEAT_ACC is
	    Port (
		FPGA_CLK:		 in STD_LOGIC;
		PS_AR_BUS_TTHP2B:	 in STD_LOGIC;
		...
		PS_AR_BUS_TTHP4B:	 in STD_LOGIC;
		MS_MEM_AR_TO_I_AR_TTHP2B:	 out STD_LOGIC;
		MS_AR_BUS_GTD_OUT_TTHP2B:	 out STD_LOGIC;
		PY_MEM_AR_TTHP2B_TO_MOD:	 out STD_LOGIC;
		MY_MEM_AR_TTHP2B:	 out STD_LOGIC;
		MS_MEM_AR_TO_I_AR_TTHP4B:	 out STD_LOGIC;
		MY_MEM_AR_NOT_TTHP4B:	 out STD_LOGIC;
		MS_AR_BUS_GTD_OUT_TTHP4B:	 out STD_LOGIC;
		PY_MEM_AR_TTHP4B_TO_MOD:	 out STD_LOGIC;
		MY_MEM_AR_TTHP4B:	 out STD_LOGIC;
		LAMP_11C8H05:	 out STD_LOGIC;
		LAMP_11C8G05:	 out STD_LOGIC);
end ALD_14_17_14_1_MEM_AR_TTHP_2_AND_4_BIT_FEAT_ACC;

architecture behavioral of ALD_14_17_14_1_MEM_AR_TTHP_2_AND_4_BIT_FEAT_ACC is 
...
begin
	...
	OUT_5B_NoPin <= NOT PS_AR_BUS_TTHP2B;
	...
	OUT_5H_NoPin <= PS_AR_BUS_TTHP4B;
	OUT_4H_NoPin <= OUT_5H_NoPin AND PS_SET_MEM_AR_1_GATED;
	OUT_2H_C <= NOT OUT_2G_K;
	LAMP_11C8G05 <= OUT_2H_C;
	OUT_5I_C <= NOT(PS_ADDR_SCNR_6_POS AND PS_AR_BUS_TTHP4B );
	OUT_2I_R <= OUT_2G_K;
	OUT_1I_A <= NOT(OUT_2I_R OR MY_LOGIC_GATE_F_OR_W );

	MS_MEM_AR_TO_I_AR_TTHP2B <= OUT_1A_D;
	MS_AR_BUS_GTD_OUT_TTHP2B <= OUT_5D_C;
	MY_MEM_AR_TTHP2B <= OUT_2D_R;
	PY_MEM_AR_TTHP2B_TO_MOD <= OUT_1D_A;
	MS_MEM_AR_TO_I_AR_TTHP4B <= OUT_1F_D;
	MY_MEM_AR_NOT_TTHP4B <= OUT_1G_E;
	MS_AR_BUS_GTD_OUT_TTHP4B <= OUT_5I_C;
	MY_MEM_AR_TTHP4B <= OUT_2I_R;
	PY_MEM_AR_TTHP4B_TO_MOD <= OUT_1I_A;
