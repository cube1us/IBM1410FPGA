-- VHDL for IBM SMS ALD page 42.10.02.1
-- Title: CONSOLE ASSEMBLY 2 BIT
-- IBM Machine Name 1411
-- Generated by GenerateHDL at 10/25/2020 10:17:54 AM
...
entity ALD_42_10_02_1_CONSOLE_ASSEMBLY_2_BIT is
	    Port (
		...
		PS_A_DATA_REG_2_BIT:	 in STD_LOGIC;
		...
		PS_CONSOLE_OUTPUT_2_BIT:	 out STD_LOGIC);
end ALD_42_10_02_1_CONSOLE_ASSEMBLY_2_BIT;

architecture behavioral of ALD_42_10_02_1_CONSOLE_ASSEMBLY_2_BIT is 
...
begin
	...
	OUT_5A_NoPin <= NOT(PS_AR_EXIT_CH_2_BIT AND PS_CONS_ADDR_REG_EXIT_GATE );
	OUT_5B_NoPin <= NOT(PS_OP_REG_2_BIT AND PS_CONS_MX_19_POS );
	OUT_4B_F <= NOT(OUT_5A_NoPin AND OUT_5B_NoPin AND OUT_5C_NoPin );
	OUT_5C_NoPin <= NOT(PS_OP_MOD_REG_2_BIT AND PS_CONS_MX_20_POS );
	OUT_3C_NoPin <= NOT(PS_E_CH_U_SEL_REG_2_BIT AND PS_CONS_MX_26_POS );
	OUT_5D_NoPin <= NOT(PS_A_DATA_REG_2_BIT AND PS_CONS_MX_22_POS );
	OUT_3D_NoPin <= NOT(PS_E_CH_UNIT_NU_REG_2_BIT AND PS_CONS_MX_27_POS );
	OUT_2D_F <= NOT(OUT_3C_NoPin AND OUT_3D_NoPin AND OUT_3E_NoPin );
	OUT_5E_NoPin <= NOT(PS_B_CH_2_BIT AND PS_CONS_B_DATA_CH_GATE );
	OUT_4E_F <= NOT(OUT_5D_NoPin AND OUT_5E_NoPin AND OUT_5F_NoPin );
	OUT_3E_NoPin <= NOT(PS_F_CH_U_SEL_REG_2_BIT AND PS_CONS_MX_28_POS );
	OUT_5F_NoPin <= NOT(PS_ASSEMBLY_CH_2_BIT AND PS_CONS_MX_24_POS );
	OUT_5G_NoPin <= NOT(PS_F_CH_UNIT_NU_REG_2_BIT AND PS_CONS_MX_29_POS );
	OUT_4G_F <= NOT(OUT_5G_NoPin AND OUT_5H_NoPin AND MS_SPECIAL_CHAR_S );
	OUT_5H_NoPin <= NOT(PS_E2_REG_2_BIT AND PS_CONS_E2_REG_GATE );
	OUT_4I_C <= NOT(MS_SPECIAL_CHAR_C AND MS_SPECIAL_CHAR_B AND MS_SPECIAL_CHAR_POUND );
	OUT_DOT_1D <= OUT_4B_F OR OUT_2D_F OR OUT_4E_F OR OUT_4G_F OR OUT_4I_C;

	PS_CONSOLE_OUTPUT_2_BIT <= OUT_DOT_1D;
